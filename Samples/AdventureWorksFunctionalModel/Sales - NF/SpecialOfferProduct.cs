...
namespace AdventureWorksModel
{
    ...
    {
        public static Product Updating(Product p, [Now] DateTime now) => p with { ModifiedDate = now };
        public static Product Persisting(Product p, [Now] DateTime now, Guid guid) => p with { rowguid = guid, ModifiedDate = now };
