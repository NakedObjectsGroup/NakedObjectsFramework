...
public class DevelopmentStoryTests_usingNewFramework {
    ...
    public void UseOfRandomSeedGenerator() {
        var prod1Title = helper.GotoHome().OpenMainMenu("Products")
                               ...
                               .GetTitle();
        helper.GotoHome();
        var prod2Title = helper.GotoHome().OpenMainMenu("Products")
                               .GetActionWithoutDialog("Random Product")
                               .ClickToViewObject()
                               .GetTitle();
    ...
    public void EditAction() {
        ...
        var original = offer.GetProperty("Max Qty").GetValue();
        var newQty = new Random().Next(1000).ToString();
    ...
    public void CreateAGraphOfTwoNewRelatedObjects() {
        ...
        var rand = new Random().Next(1970, 2021);
    ...
    public void InlineMultiPropertyEdit() {
        ...
        dialog.GetTextField("Start Date").AssertDefaultValueIs("25 Jun 2008").Clear().Enter("26 Jun 2008");
        dialog.GetTextField("Due Date").AssertDefaultValueIs("6 Jul 2008").Clear().Enter("7 Jul 2008");
        Thread.Sleep(1000);
        wo = dialog.ClickOKToViewObject();
        wo.GetProperty("Start Date").AssertValueIs("26 Jun 2008");
        dialog = wo.GetProperty("Due Date").AssertValueIs("7 Jul 2008").ClickOnEditIcon();
        dialog.GetTextField("Start Date").Clear().Enter("25 Jun 2008");
        dialog.GetTextField("Due Date").Clear().Enter("6 Jul 2008");
        Thread.Sleep(1000);
        wo = dialog.ClickOKToViewObject();
        wo.GetProperty("Start Date").AssertValueIs("25 Jun 2008");
