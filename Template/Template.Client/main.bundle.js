...
var clientVersion = '9.0.0-beta.1';
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rep_loader_service__ = __webpack_require__(251);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constants__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_Subject__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__logger_service__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__rxjs_extensions__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_common__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__logger_service__ = __webpack_require__(72);
...
var UrlManagerService = (function () {
    function UrlManagerService(router, location, configService, loggerService) {
        ...
        this.setMenu = function (menuId, paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [menuId]);
        ...
        this.setDialog = function (dialogId, paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [dialogId]);
        ...
        this.setObject = function (resultObject, paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [oid]);
        ...
        this.setObjectWithMode = function (resultObject, newMode, paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([okey, mkey], [oid, __WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */][newMode]]);
        ...
        this.setList = function (actionMember, parms, fromPaneId, toPaneId) {
            ...
            if (parent instanceof __WEBPACK_IMPORTED_MODULE_1__models__["o" /* DomainObjectRepresentation */]) {
                newValues[("" + akm.object + toPaneId)] = parent.id(_this.keySeparator);
            }
            if (parent instanceof __WEBPACK_IMPORTED_MODULE_1__models__["P" /* MenuRepresentation */]) {
            ...
            var newState = actionMember.extensions().renderEagerly() ? __WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */][__WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */].Table] : __WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */][__WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */].List];
            ...
            __WEBPACK_IMPORTED_MODULE_0_lodash__["forEach"](parms, function (p, id) { return _this.setId("" + akm.parm + toPaneId + "_" + id, p.toJsonString(_this.shortCutMarker, _this.urlShortCuts), newValues); });
        ...
        this.setAttachment = function (attachmentlink, paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([okey, akey], [oid, pid]);
        ...
        this.toggleObjectMenu = function (paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [actionsId]);
        ...
        this.setCollectionMemberState = function (collectionMemberId, state, paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [__WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */][state]]);
            _this.executeTransition(newValues, paneId, Transition.Null, function () { return true; });
        };
        ...
        this.setInteractionMode = function (newMode, paneId) {
            ...
            var transition;
            if (currentMode === __WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */].Edit && newMode !== __WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */].Edit) {
                transition = Transition.LeaveEdit;
            }
            else if (newMode === __WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */].Transient) {
                transition = Transition.ToTransient;
            }
            else {
                transition = Transition.Null;
            }
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [__WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */][newMode]]);
        ...
        this.setItemSelected = function (item, isSelected, collectionId, paneId) {
            ...
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [currentSelectedAsString]);
            _this.executeTransition(newValues, paneId, Transition.Null, function () { return true; });
        };
        this.setAllItemsSelected = function (isSelected, collectionId, paneId) {
            ...
            var currentSelected = _this.getSearch()[key];
            var selectedArray = _this.arrayFromMask(currentSelected);
            __WEBPACK_IMPORTED_MODULE_0_lodash__["fill"](selectedArray, isSelected);
            var currentSelectedAsString = (_this.createMask(selectedArray)).toString();
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [currentSelectedAsString]);
            _this.executeTransition(newValues, paneId, Transition.Null, function () { return true; });
        };
        this.setListPaging = function (newPage, newPageSize, state, paneId) {
            ...
            pageValues[("" + akm.collection + paneId)] = __WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */][state];
        ...
        this.setError = function (errorCategory, ec) {
            ...
            var search = {};
            // always on pane 1
            search[akm.errorCat + 1] = __WEBPACK_IMPORTED_MODULE_1__models__["b" /* ErrorCategory */][errorCategory];
            var result = { path: newPath, search: search, replace: false };
            if (errorCategory === __WEBPACK_IMPORTED_MODULE_1__models__["b" /* ErrorCategory */].HttpClientError && ec === __WEBPACK_IMPORTED_MODULE_1__models__["q" /* HttpStatusCode */].PreconditionFailed) {
                result.replace = true;
            }
            _this.setNewSearch(result);
        };
        this.getRouteData = function () {
            var routeData = new __WEBPACK_IMPORTED_MODULE_3__route_data__["d" /* RouteData */](_this.configService, _this.loggerService);
        ...
        this.getUrlState = function (paneId) {
            ...
            var path = _this.getPath();
            var segments = path.split("/");
            var paneType = segments[paneId + 1] || __WEBPACK_IMPORTED_MODULE_2__constants__["i" /* homePath */];
            var paneSearch = _this.capturePane(paneId);
            // clear any dialogs so we don't return  to a dialog
            paneSearch = __WEBPACK_IMPORTED_MODULE_0_lodash__["omit"](paneSearch, "" + akm.dialog + paneId);
        ...
        this.getListCacheIndexFromSearch = function (search, paneId, newPage, newPageSize, format) {
            ...
            var parms = __WEBPACK_IMPORTED_MODULE_0_lodash__["pickBy"](search, function (v, k) { return !!k && k.indexOf(akm.parm + paneId) === 0; });
            var mappedParms = __WEBPACK_IMPORTED_MODULE_0_lodash__["mapValues"](parms, function (v) { return decodeURIComponent(__WEBPACK_IMPORTED_MODULE_1__models__["Q" /* decompress */](v, _this.shortCutMarker, _this.urlShortCuts)); });
            var s4 = __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](mappedParms, function (r, n, k) { return r + (k + "=" + n + _this.keySeparator); }, "");
            var s5 = "" + newPage;
            var s6 = "" + newPageSize;
            var s7 = format ? "" + format : "";
            var ss = [s1, s2, s3, s4, s5, s6, s7];
            return __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](ss, function (r, n) { return r + _this.keySeparator + n; }, "");
        };
        ...
        this.popUrlState = function (paneId) {
            ...
            if (capturedPane) {
                ...
                search = __WEBPACK_IMPORTED_MODULE_0_lodash__["merge"](search, capturedPane.search);
                var path = void 0;
                var replace = void 0;
        ...
        this.swapPanes = function () {
            var path = _this.getPath();
            var segments = path.split("/");
            var mode = segments[1], oldPane1 = segments[2], _a = segments[3], oldPane2 = _a === void 0 ? __WEBPACK_IMPORTED_MODULE_2__constants__["i" /* homePath */] : _a;
            var newPath = "/" + mode + "/" + oldPane2 + "/" + oldPane1;
            var search = _this.swapSearchIds(_this.getSearch());
            _this.currentPaneId = __WEBPACK_IMPORTED_MODULE_1__models__["O" /* getOtherPane */](_this.currentPaneId);
            var tree = _this.router.createUrlTree([newPath], { queryParams: search });
            _this.router.navigateByUrl(tree);
        };
        this.cicero = function () { return _this.setMode(__WEBPACK_IMPORTED_MODULE_2__constants__["j" /* ciceroPath */]); };
        this.gemini = function () { return _this.setMode(__WEBPACK_IMPORTED_MODULE_2__constants__["k" /* geminiPath */]); };
        this.applicationProperties = function () {
            var newPath = "/" + __WEBPACK_IMPORTED_MODULE_2__constants__["k" /* geminiPath */] + "/" + __WEBPACK_IMPORTED_MODULE_2__constants__["l" /* applicationPropertiesPath */];
        ...
        this.setHomeSinglePane = function () {
            ...
            var segments = path.split("/");
            var mode = segments[1];
            var newPath = "/" + mode + "/" + __WEBPACK_IMPORTED_MODULE_2__constants__["i" /* homePath */];
        ...
        this.singlePane = function (paneId) {
            ...
            if (!_this.isSinglePane()) {
                ...
                var paneToRemoveId = __WEBPACK_IMPORTED_MODULE_1__models__["O" /* getOtherPane */](paneToKeepId);
                var path = _this.getPath();
                var segments = path.split("/");
                var mode = segments[1];
        ...
        this.isHome = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["i" /* homePath */]);
        };
        this.isObject = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["m" /* objectPath */]);
        };
        this.isList = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["n" /* listPath */]);
        };
        this.isError = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["o" /* errorPath */]);
        };
        this.isRecent = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["p" /* recentPath */]);
        };
        this.isAttachment = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["q" /* attachmentPath */]);
        };
        this.isApplicationProperties = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["l" /* applicationPropertiesPath */]);
        };
        this.isMultiLineDialog = function (paneId) {
            if (paneId === void 0) { paneId = 1; }
            return _this.isLocation(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["r" /* multiLineDialogPath */]);
        };
    ...
    UrlManagerService.prototype.createMask = function (arr) {
        ...
        var masks = __WEBPACK_IMPORTED_MODULE_0_lodash__["map"](arrays, function (a) { return _this.createSubMask(a).toString(); });
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](masks, function (res, val) { return res + "-" + val; });
    };
    ...
    UrlManagerService.prototype.arrayFromMask = function (sMask) {
        ...
        var maskArrays = __WEBPACK_IMPORTED_MODULE_0_lodash__["map"](sMasks, function (s) { return _this.arrayFromSubMask(s); });
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["reduce"](maskArrays, function (res, val) { return res.concat(val); }, []);
    };
    ...
    UrlManagerService.prototype.getIds = function (typeOfId, paneId) {
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["pickBy"](this.getSearch(), function (v, k) { return !!k && k.indexOf(typeOfId + paneId) === 0; });
    };
    UrlManagerService.prototype.mapIds = function (ids) {
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["mapKeys"](ids, function (v, k) { return k.substr(k.indexOf("_") + 1); });
    };
    ...
    UrlManagerService.prototype.getMappedValues = function (mappedIds) {
        var _this = this;
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["mapValues"](mappedIds, function (v) { return __WEBPACK_IMPORTED_MODULE_1__models__["j" /* Value */].fromJsonString(v, _this.shortCutMarker, _this.urlShortCuts); });
    };
    UrlManagerService.prototype.getInteractionMode = function (rawInteractionMode) {
        return rawInteractionMode ? __WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */][rawInteractionMode] : __WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */].View;
    };
    UrlManagerService.prototype.setPaneRouteDataFromParms = function (paneRouteData, paneId, routeParams) {
        ...
        paneRouteData.errorCategory = rawErrorCategory ? __WEBPACK_IMPORTED_MODULE_1__models__["b" /* ErrorCategory */][rawErrorCategory] : null;
        ...
        paneRouteData.state = rawCollectionState ? __WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */][rawCollectionState] : __WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */].List;
        ...
        paneRouteData.collections = __WEBPACK_IMPORTED_MODULE_0_lodash__["mapValues"](collKeyMap, function (v) { return __WEBPACK_IMPORTED_MODULE_3__route_data__["b" /* CollectionViewState */][v]; });
        var collSelectedKeyMap = this.getAndMapIds(akm.selected, paneId);
        paneRouteData.selectedCollectionItems = __WEBPACK_IMPORTED_MODULE_0_lodash__["mapValues"](collSelectedKeyMap, function (v) { return _this.arrayFromMask(v); });
    ...
    UrlManagerService.prototype.searchKeysForPane = function (search, paneId, raw) {
        var ids = __WEBPACK_IMPORTED_MODULE_0_lodash__["map"](raw, function (s) { return s + paneId; });
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["filter"](__WEBPACK_IMPORTED_MODULE_0_lodash__["keys"](search), function (k) { return __WEBPACK_IMPORTED_MODULE_0_lodash__["some"](ids, function (id) { return k.indexOf(id) === 0; }); });
    };
    UrlManagerService.prototype.allSearchKeysForPane = function (search, paneId) {
        var raw = __WEBPACK_IMPORTED_MODULE_0_lodash__["values"](akm);
    ...
    UrlManagerService.prototype.clearPane = function (search, paneId) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["omit"](search, toClear);
    };
    ...
    UrlManagerService.prototype.paneIsAlwaysSingle = function (paneType) {
        return paneType === __WEBPACK_IMPORTED_MODULE_2__constants__["r" /* multiLineDialogPath */];
    };
    ...
    UrlManagerService.prototype.capturePane = function (paneId) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["pick"](search, toCapture);
    };
    UrlManagerService.prototype.getOidFromHref = function (href) {
        var oid = __WEBPACK_IMPORTED_MODULE_1__models__["d" /* ObjectIdWrapper */].fromHref(href, this.keySeparator);
        return oid.getKey();
    };
    UrlManagerService.prototype.getPidFromHref = function (href) {
        return __WEBPACK_IMPORTED_MODULE_1__models__["R" /* propertyIdFromUrl */](href);
    };
    ...
    UrlManagerService.prototype.getId = function (key, search) {
        return __WEBPACK_IMPORTED_MODULE_1__models__["Q" /* decompress */](search[key], this.shortCutMarker, this.urlShortCuts);
    };
    UrlManagerService.prototype.setId = function (key, id, search) {
        search[key] = __WEBPACK_IMPORTED_MODULE_1__models__["S" /* compress */](id, this.shortCutMarker, this.urlShortCuts);
    };
    ...
    UrlManagerService.prototype.validKeys = function (path) {
        switch (path) {
            case __WEBPACK_IMPORTED_MODULE_2__constants__["i" /* homePath */]:
                return this.validKeysForHome();
            case __WEBPACK_IMPORTED_MODULE_2__constants__["m" /* objectPath */]:
                return this.validKeysForObject();
            case __WEBPACK_IMPORTED_MODULE_2__constants__["n" /* listPath */]:
                return this.validKeysForList();
            case __WEBPACK_IMPORTED_MODULE_2__constants__["r" /* multiLineDialogPath */]:
                return this.validKeysForMultiLineDialog();
            case __WEBPACK_IMPORTED_MODULE_2__constants__["q" /* attachmentPath */]:
    ...
    UrlManagerService.prototype.clearInvalidParmsFromSearch = function (paneId, search, path) {
        if (path) {
            ...
            var ivks = __WEBPACK_IMPORTED_MODULE_0_lodash__["without"].apply(__WEBPACK_IMPORTED_MODULE_0_lodash__, [__WEBPACK_IMPORTED_MODULE_0_lodash__["values"](akm)].concat(vks));
    ...
    UrlManagerService.prototype.handleTransition = function (paneId, search, transition) {
        ...
        switch (transition) {
            case (Transition.ToHome):
                (_a = this.setupPaneNumberAndTypes(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["i" /* homePath */]), path = _a.path, replace = _a.replace, _a);
            ...
            case (Transition.ToObjectView):
                (_b = this.setupPaneNumberAndTypes(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["m" /* objectPath */]), path = _b.path, replace = _b.replace, _b);
                replace = false;
                search = this.clearPane(search, paneId);
                this.setId(akm.interactionMode + paneId, __WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */][__WEBPACK_IMPORTED_MODULE_3__route_data__["a" /* InteractionMode */].View], search);
                break;
            case (Transition.ToObjectWithMode):
                (_c = this.setupPaneNumberAndTypes(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["m" /* objectPath */]), path = _c.path, replace = _c.replace, _c);
                replace = false;
                search = this.clearPane(search, paneId);
                break;
            case (Transition.ToList):
                (_d = this.setupPaneNumberAndTypes(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["n" /* listPath */]), path = _d.path, replace = _d.replace, _d);
            ...
            case (Transition.ToRecent):
                (_e = this.setupPaneNumberAndTypes(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["p" /* recentPath */]), path = _e.path, replace = _e.replace, _e);
                search = this.clearPane(search, paneId);
                break;
            case (Transition.ToAttachment):
                (_f = this.setupPaneNumberAndTypes(paneId, __WEBPACK_IMPORTED_MODULE_2__constants__["q" /* attachmentPath */]), path = _f.path, replace = _f.replace, _f);
                search = this.clearPane(search, paneId);
                break;
            case (Transition.ToMultiLineDialog):
                (_g = this.setupPaneNumberAndTypes(1, __WEBPACK_IMPORTED_MODULE_2__constants__["r" /* multiLineDialogPath */]), path = _g.path, replace = _g.replace, _g); // always on 1
                if (paneId === 2) {
                    // came from 2 
    ...
    UrlManagerService.prototype.executeTransition = function (newValues, paneId, transition, condition) {
        ...
        if (condition(search)) {
            ...
            (path = result.path, search = result.search, result);
            __WEBPACK_IMPORTED_MODULE_0_lodash__["forEach"](newValues, function (v, k) {
    ...
    UrlManagerService.prototype.closeOrCancelDialog = function (id, paneId, transition) {
        ...
        if (existingValue === id) {
            var newValues = __WEBPACK_IMPORTED_MODULE_0_lodash__["zipObject"]([key], [null]);
    ...
    UrlManagerService.prototype.getViewType = function (view) {
        switch (view) {
            case __WEBPACK_IMPORTED_MODULE_2__constants__["i" /* homePath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].Home;
            case __WEBPACK_IMPORTED_MODULE_2__constants__["m" /* objectPath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].Object;
            case __WEBPACK_IMPORTED_MODULE_2__constants__["n" /* listPath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].List;
            case __WEBPACK_IMPORTED_MODULE_2__constants__["o" /* errorPath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].Error;
            case __WEBPACK_IMPORTED_MODULE_2__constants__["p" /* recentPath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].Recent;
            case __WEBPACK_IMPORTED_MODULE_2__constants__["q" /* attachmentPath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].Attachment;
            case __WEBPACK_IMPORTED_MODULE_2__constants__["l" /* applicationPropertiesPath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].ApplicationProperties;
            case __WEBPACK_IMPORTED_MODULE_2__constants__["r" /* multiLineDialogPath */]: return __WEBPACK_IMPORTED_MODULE_3__route_data__["c" /* ViewType */].MultiLineDialog;
        }
    ...
    UrlManagerService.prototype.swapSearchIds = function (search) {
        return __WEBPACK_IMPORTED_MODULE_0_lodash__["mapKeys"](search, function (v, k) { return k.replace(/(\D+)(\d{1})(\w*)/, function (match, p1, p2, p3) { return ("" + p1 + (p2 === "1" ? "2" : "1") + p3); }); });
    };
    ...
    UrlManagerService = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_core__["f" /* Injectable */])(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* Router */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_7__angular_common__["c" /* Location */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__angular_common__["c" /* Location */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_8__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__config_service__["a" /* ConfigService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_9__logger_service__["a" /* LoggerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_9__logger_service__["a" /* LoggerService */]) === 'function' && _d) || Object])
    ], UrlManagerService);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__mask_service__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__cicero_commands__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__error_service__ = __webpack_require__(27);
...
var CiceroRendererService = (function () {
            ...
            if (cvm.message) {
                ...
                _this.context.getObject(1, oid, routeData.interactionMode) //TODO: move following code out into a ICireroRenderers service with methods for rendering each context type
                    ...
                    if (reject.category === __WEBPACK_IMPORTED_MODULE_0__models__["b" /* ErrorCategory */].ClientError && reject.clientErrorCode === __WEBPACK_IMPORTED_MODULE_0__models__["c" /* ClientErrorCode */].ExpiredTransient) {
                        cvm.setOutputSource(__WEBPACK_IMPORTED_MODULE_1__user_messages__["f" /* errorExpiredTransient */]);
                    }
                    else {
    ...
    CiceroRendererService.prototype.renderHome = function (cvm, routeData) {
        if (cvm.message) {
            ...
            if (routeData.menuId) {
                ...
                cvm.clearInput();
                cvm.setOutputSource(__WEBPACK_IMPORTED_MODULE_1__user_messages__["l" /* welcomeMessage */]);
            }
        }
    };
    ;
    ...
    CiceroRendererService.prototype.renderOpenCollection = function (collId, obj, cvm) {
        ...
        output += "(" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["m" /* collection */] + " " + __WEBPACK_IMPORTED_MODULE_1__user_messages__["n" /* on */] + " " + __WEBPACK_IMPORTED_MODULE_0__models__["e" /* typePlusTitle */](obj) + ")";
        cvm.clearInputRenderOutputAndAppendAlertIfAny(output);
    };
    CiceroRendererService.prototype.renderTransientObject = function (routeData, obj, cvm) {
        var output = __WEBPACK_IMPORTED_MODULE_1__user_messages__["o" /* unsaved */] + " ";
    ...
    CiceroRendererService.prototype.renderForm = function (routeData, obj, cvm) {
        var _this = this;
        var output = __WEBPACK_IMPORTED_MODULE_1__user_messages__["p" /* editing */] + " ";
    ...
    CiceroRendererService.prototype.renderOpenMenu = function (routeData, cvm) {
        ...
        this.context.getMenu(routeData.menuId).
            then(function (menu) {
            output += __WEBPACK_IMPORTED_MODULE_1__user_messages__["q" /* menuTitle */](menu.title());
    ...
    CiceroRendererService.prototype.renderModifiedProperties = function (obj, routeData, mask) {
        ...
        if (_.keys(props).length > 0) {
            output += __WEBPACK_IMPORTED_MODULE_1__user_messages__["r" /* modifiedProperties */] + ":\n";
...
function renderFieldValue(field, value, mask) {
    if (!field.isScalar()) {
        return value.isNull() ? __WEBPACK_IMPORTED_MODULE_1__user_messages__["s" /* empty */] : value.toString();
    }
    ...
    if (properScalarValue === "" || properScalarValue == null) {
        return __WEBPACK_IMPORTED_MODULE_1__user_messages__["s" /* empty */];
    }
    else {
...
function renderCollectionNameAndSize(coll) {
    ...
    switch (coll.size()) {
        case 0:
            output += __WEBPACK_IMPORTED_MODULE_1__user_messages__["s" /* empty */];
            break;
        case 1:
            output += "1 " + __WEBPACK_IMPORTED_MODULE_1__user_messages__["t" /* item */];
            break;
        default:
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__type_result_cache__ = __webpack_require__(388);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config_service__ = __webpack_require__(16);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__custom_component_config_service__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__object_object_component__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__list_list_component__ = __webpack_require__(383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__type_result_cache__ = __webpack_require__(388);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__error_error_component__ = __webpack_require__(380);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config_service__ = __webpack_require__(16);
...
var LocalCurrencyFilter = (function () {
    ...
    LocalCurrencyFilter.prototype.filter = function (val) {
        ...
        var pipe = new __WEBPACK_IMPORTED_MODULE_1__angular_common__["d" /* CurrencyPipe */](this.locale);
...
var LocalDateFilter = (function () {
    ...
    LocalDateFilter.prototype.filter = function (val) {
        ...
        var pipe = new __WEBPACK_IMPORTED_MODULE_1__angular_common__["e" /* DatePipe */](this.locale);
        return transform(function () { return pipe.transform(val, _this.mask); });
    };
    return LocalDateFilter;
}());
var LocalNumberFilter = (function () {
    function LocalNumberFilter(locale, fractionSize) {
        this.locale = locale;
    ...
    LocalNumberFilter.prototype.filter = function (val) {
        ...
        var pipe = new __WEBPACK_IMPORTED_MODULE_1__angular_common__["f" /* DecimalPipe */](this.locale);
        return transform(function () { return pipe.transform(val); });
    };
...
var MaskService = (function () {
    ...
    ;
    MaskService.prototype.setNumberMaskMapping = function (customMask, format, fractionSize, locale) {
    ...
    MaskService.prototype.configureFromConfig = function () {
        ...
        if (maskConfig) {
            ...
            if (numberMasks) {
                __WEBPACK_IMPORTED_MODULE_0_lodash__["forEach"](numberMasks, function (v, k) { return _this.setNumberMaskMapping(k, v.format, v.fractionSize, v.locale); });
            }
        }
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_observable_of__ = __webpack_require__(932);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_observable_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs_add_observable_of__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_throw__ = __webpack_require__(933);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_throw___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_throw__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_catch__ = __webpack_require__(934);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_catch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_catch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_debounceTime__ = __webpack_require__(935);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_debounceTime___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_debounceTime__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_distinctUntilChanged__ = __webpack_require__(936);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_distinctUntilChanged___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_distinctUntilChanged__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_do__ = __webpack_require__(937);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_do___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_do__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_filter__ = __webpack_require__(938);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_filter___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_filter__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_map__ = __webpack_require__(939);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_switchMap__ = __webpack_require__(940);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_switchMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_switchMap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_add_operator_toPromise__ = __webpack_require__(941);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__message_view_model__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_view_models__ = __webpack_require__(28);
        ...
        this.doInvoke = function (right) {
            return _this.execute(right)
                ...
                if (actionResult.shouldExpectResult()) {
                    _this.setMessage(actionResult.warningsOrMessages() || __WEBPACK_IMPORTED_MODULE_1__user_messages__["_85" /* noResultMessage */]);
                }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__message_view_model__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__choice_view_model__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_view_models__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__user_messages__ = __webpack_require__(23);
...
var DomainObjectViewModel = (function (_super) {
    ...
    function DomainObjectViewModel(colorService, contextService, viewModelFactory, urlManager, error, configService, obj, routeData, forceReload) {
        ...
        this.doEdit = function () {
            ...
            _this.contextService.getObjectForEdit(_this.onPaneId, _this.domainObject)
                .then(function (updatedObject) {
                _this.reset(updatedObject, _this.urlManager.getRouteData().pane(_this.onPaneId), true);
        ...
        this.doReload = function () {
            ...
            _this.contextService.reloadObject(_this.onPaneId, _this.domainObject)
                .then(function (updatedObject) { return _this.reset(updatedObject, _this.urlManager.getRouteData().pane(_this.onPaneId), true); })
                .catch(function (reject) { return _this.handleWrappedError(reject); });
        };
        ...
        this.showActions = function () { return !!_this.urlManager.getRouteData().pane(_this.onPaneId).actionsOpen; };
        this.keySeparator = configService.config.keySeparator;
    ...
    ;
    DomainObjectViewModel.prototype.propertyMap = function () {
        var pps = __WEBPACK_IMPORTED_MODULE_5_lodash__["filter"](this.properties, function (property) { return property.isEditable; });
    ...
    DomainObjectViewModel.prototype.concurrency = function () {
        ...
        this.contextService.getObject(this.onPaneId, this.domainObject.getOid(this.keySeparator), this.routeData.interactionMode)
            ...
            var em = new __WEBPACK_IMPORTED_MODULE_3__models__["w" /* ErrorMap */]({}, 0, __WEBPACK_IMPORTED_MODULE_6__user_messages__["_91" /* concurrencyMessage */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__message_view_model__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__choice_view_model__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helpers_view_models__ = __webpack_require__(28);
...
var FieldViewModel = (function (_super) {
    ...
    FieldViewModel.prototype.isValid = function (viewValue) {
        ...
        if (this.entryType === __WEBPACK_IMPORTED_MODULE_2__models__["h" /* EntryType */].AutoComplete && !(viewValue instanceof __WEBPACK_IMPORTED_MODULE_1__choice_view_model__["a" /* ChoiceViewModel */])) {
            if (val) {
                this.setMessage(__WEBPACK_IMPORTED_MODULE_3__user_messages__["_87" /* pendingAutoComplete */]);
    ...
    FieldViewModel.prototype.setupAutocomplete = function (rep, parentValues, digest) {
        ...
        this.description = this.description || __WEBPACK_IMPORTED_MODULE_3__user_messages__["_88" /* autoCompletePrompt */];
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_85", function() { return noResultMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_92", function() { return obscuredText; });
...
/* unused harmony export notANumber */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return mandatory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_26", function() { return optional; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_27", function() { return choices; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_87", function() { return pendingAutoComplete; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return noPatternMatch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_79", function() { return closeActions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_80", function() { return noActions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_81", function() { return openActions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_77", function() { return mandatoryFieldsPrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_78", function() { return invalidFieldsPrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_93", function() { return unknownFileTitle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_82", function() { return unknownCollectionSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_83", function() { return emptyCollectionSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_90", function() { return noItemsFound; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_84", function() { return noItemsSelected; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_86", function() { return dropPrompt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_88", function() { return autoCompletePrompt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_91", function() { return concurrencyMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_97", function() { return loadingMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_94", function() { return submittedMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return outOfRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_89", function() { return pageMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_96", function() { return logOffMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_95", function() { return submittedCount; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return welcomeMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_38", function() { return basicHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "H", function() { return actionCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "I", function() { return actionHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "T", function() { return backCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "U", function() { return backHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "V", function() { return cancelCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "W", function() { return cancelHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "X", function() { return clipboardCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Z", function() { return clipboardCopy; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_0", function() { return clipboardShow; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_1", function() { return clipboardGo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_2", function() { return clipboardDiscard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Y", function() { return clipboardHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_7", function() { return editCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_8", function() { return editHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_9", function() { return enterCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_10", function() { return enterHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_28", function() { return forwardCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_29", function() { return forwardHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_30", function() { return geminiCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_31", function() { return geminiHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_32", function() { return gotoCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_33", function() { return gotoHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_36", function() { return helpCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_37", function() { return helpHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_39", function() { return menuCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_40", function() { return menuHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_44", function() { return okCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_45", function() { return okHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_47", function() { return pageCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_49", function() { return pageFirst; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_50", function() { return pagePrevious; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_52", function() { return pageNext; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_54", function() { return pageLast; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_48", function() { return pageHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_57", function() { return reloadCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_58", function() { return reloadHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_59", function() { return rootCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_60", function() { return rootHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_61", function() { return saveCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_62", function() { return saveHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_63", function() { return selectionCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_64", function() { return selectionHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_65", function() { return showCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_66", function() { return showHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_72", function() { return whereCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_73", function() { return whereHelp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_74", function() { return commandTooShort; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_75", function() { return noCommandMatch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_76", function() { return commandsAvailable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return noArguments; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "w", function() { return tooFewArguments; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return tooManyArguments; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return commandNotAvailable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_71", function() { return startHigherEnd; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_70", function() { return highestItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return item; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return empty; });
/* unused harmony export numberOfItems */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return on; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return collection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_69", function() { return modified; });
/* unused harmony export properties */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return modifiedProperties; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_68", function() { return noVisible; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_67", function() { return doesNotMatch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_51", function() { return alreadyOnFirst; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_53", function() { return alreadyOnLast; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_55", function() { return pageArgumentWrong; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_56", function() { return pageNumberWrong; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return mayNotbeChainedMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_46", function() { return queryOnlyRider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return noSuchCommand; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "A", function() { return missingArgument; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return wrongTypeArgument; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return isNotANumber; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D", function() { return tooManyDashes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "E", function() { return mustBeGreaterThanZero; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "F", function() { return pleaseCompleteOrCorrect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "G", function() { return required; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "J", function() { return mustbeQuestionMark; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "K", function() { return noActionsAvailable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "L", function() { return doesNotMatchActions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "M", function() { return matchingActions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "N", function() { return actionsMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return actionPrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return disabledPrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return isDisabled; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "S", function() { return noDescription; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "R", function() { return descriptionPrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_3", function() { return clipboardError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_4", function() { return clipboardContextError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_5", function() { return clipboardContents; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_6", function() { return clipboardEmpty; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_11", function() { return doesNotMatchProperties; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_12", function() { return matchesMultiple; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_13", function() { return doesNotMatchDialog; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_14", function() { return multipleFieldMatches; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_15", function() { return isNotModifiable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_16", function() { return invalidCase; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_17", function() { return invalidRefEntry; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_18", function() { return emptyClipboard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_19", function() { return incompatibleClipboard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_20", function() { return noMatch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_21", function() { return multipleMatches; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_22", function() { return fieldName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_23", function() { return descriptionFieldPrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_24", function() { return typePrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_25", function() { return unModifiablePrefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_35", function() { return outOfItemRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_41", function() { return doesNotMatchMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_42", function() { return matchingMenus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return menuTitle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_43", function() { return allMenus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_34", function() { return noRefFieldMatch; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return unsaved; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return editing; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return errorUnknown; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return errorExpiredTransient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return errorWrongType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return errorNotImplemented; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return errorSoftware; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return errorConnection; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return errorClient; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cicero_commands__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mask_service__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__config_service__ = __webpack_require__(16);
    ...
    function CiceroCommandFactoryService(urlManager, location, context, mask, error, configService) {
        ...
        this.getCommand = function (commandWord) {
            if (commandWord.length < 2) {
                throw new Error(__WEBPACK_IMPORTED_MODULE_2__user_messages__["_74" /* commandTooShort */]);
            }
            var abbr = commandWord.substr(0, 2);
            var command = _this.commands[abbr];
            if (command == null) {
                throw new Error(__WEBPACK_IMPORTED_MODULE_2__user_messages__["_75" /* noCommandMatch */](abbr));
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rxjs_extensions__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_Subject__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_Subject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_Subject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__simple_lru_cache__ = __webpack_require__(698);
...
var RepLoaderService = (function () {
    function RepLoaderService(http, configService) {
        ...
        this.populate = function (model, ignoreCache) {
            var response = model;
            var config = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({
                withCredentials: true,
                url: model.getUrl(),
                method: model.method,
                body: model.getBody()
        ...
        this.getFile = function (url, mt, ignoreCache) {
            ...
            var config = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({
                ...
                headers: new __WEBPACK_IMPORTED_MODULE_1__angular_http__["e" /* Headers */]({ "Accept": mt })
            });
            var request = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["f" /* Request */](config);
        ...
        this.uploadFile = function (url, mt, file) {
            var config = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({
                ...
                url: url,
                body: file,
                headers: new __WEBPACK_IMPORTED_MODULE_1__angular_http__["e" /* Headers */]({ "Content-Type": mt })
            });
            var request = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["f" /* Request */](config);
            return _this.http.request(request)
                .toPromise()
    ...
    RepLoaderService.prototype.addIfMatchHeader = function (config, digest) {
        if (digest && (config.method === __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* RequestMethod */].Post || config.method === __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* RequestMethod */].Put || config.method === __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* RequestMethod */].Delete)) {
            config.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["e" /* Headers */]({ "If-Match": digest });
        }
    };
    ...
    RepLoaderService.prototype.httpValidate = function (config) {
        ...
        return this.http.request(new __WEBPACK_IMPORTED_MODULE_1__angular_http__["f" /* Request */](config))
            .toPromise()
            .then(function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__contributed_action_parent_view_model__ = __webpack_require__(391);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_view_models__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_lodash__);
...
var CollectionViewModel = (function (_super) {
    ...
    function CollectionViewModel(viewModelFactory, colorService, error, context, urlManager, configService, loggerService, collectionRep, routeData, forceReload) {
        ...
        this.actionMember = function (id, keySeparator) {
            ...
            _this.loggerService.throw("CollectionViewModel:actionMember no member " + id + " on " + _this.id);
        };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__choice_view_model__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models__ = __webpack_require__(5);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__field_view_model__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__choice_view_model__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(8);
...
var ParameterViewModel = (function (_super) {
    ...
    ParameterViewModel.prototype.setupParameterFreeformReference = function () {
        var parmRep = this.parameterRep;
        this.description = this.description || __WEBPACK_IMPORTED_MODULE_3__user_messages__["_86" /* dropPrompt */];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helpers_view_models__ = __webpack_require__(28);
    ...
    PropertyViewModel.prototype.setupScalarPropertyValue = function () {
        ...
        this.refresh = function (newValue) { return _this.callIfChanged(newValue, function (value) {
            ...
            if (propertyRep.entryType() === __WEBPACK_IMPORTED_MODULE_4__models__["h" /* EntryType */].Choices) {
                ...
                _this.formattedValue = __WEBPACK_IMPORTED_MODULE_3__user_messages__["_92" /* obscuredText */];
            }
            else {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_service__ = __webpack_require__(16);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__menu_item_view_model__ = __webpack_require__(703);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__choice_view_model__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
/* harmony export (immutable) */ __webpack_exports__["l"] = createForm;
/* harmony export (immutable) */ __webpack_exports__["m"] = copy;
...
function tooltip(onWhat, fields) {
    ...
    if (missingMandatoryFields.length > 0) {
        return __WEBPACK_IMPORTED_MODULE_4_lodash__["reduce"](missingMandatoryFields, function (s, t) { return s + t.title + "; "; }, __WEBPACK_IMPORTED_MODULE_3__user_messages__["_77" /* mandatoryFieldsPrefix */]);
    }
    var invalidFields = __WEBPACK_IMPORTED_MODULE_4_lodash__["filter"](fields, function (p) { return !p.clientValid; });
    if (invalidFields.length > 0) {
        return __WEBPACK_IMPORTED_MODULE_4_lodash__["reduce"](invalidFields, function (s, t) { return s + t.title + "; "; }, __WEBPACK_IMPORTED_MODULE_3__user_messages__["_78" /* invalidFieldsPrefix */]);
    }
    return "";
}
...
function createSubmenuItems(avms, menu, level) {
    ...
    if (menu.name) {
        var actions = __WEBPACK_IMPORTED_MODULE_4_lodash__["filter"](avms, function (a) { return getMenuForLevel(a.menuPath, level) === menu.name && !getMenuForLevel(a.menuPath, level + 1); });
        menu.actions = actions;
        //then collate submenus 
        var submenuActions_1 = __WEBPACK_IMPORTED_MODULE_4_lodash__["filter"](avms, function (a) { return getMenuForLevel(a.menuPath, level) === menu.name && getMenuForLevel(a.menuPath, level + 1); });
        var menus = __WEBPACK_IMPORTED_MODULE_4_lodash__["chain"](submenuActions_1)
            .map(function (a) { return new __WEBPACK_IMPORTED_MODULE_0__menu_item_view_model__["a" /* MenuItemViewModel */](getMenuForLevel(a.menuPath, level + 1), null, null); })
            .value();
        menus = removeDuplicateMenus(menus);
        menu.menuItems = __WEBPACK_IMPORTED_MODULE_4_lodash__["map"](menus, function (m) { return createSubmenuItems(submenuActions_1, m, level + 1); });
    }
    return menu;
}
function createMenuItems(avms) {
    ...
    var menus = __WEBPACK_IMPORTED_MODULE_4_lodash__["chain"](avms)
        .map(function (a) { return new __WEBPACK_IMPORTED_MODULE_0__menu_item_view_model__["a" /* MenuItemViewModel */](getMenuForLevel(a.menuPath, 0), [a], null); })
        .value();
    // remove non unique submenus 
    menus = removeDuplicateMenus(menus);
    // update submenus with all actions under same submenu
    return __WEBPACK_IMPORTED_MODULE_4_lodash__["map"](menus, function (m) { return createSubmenuItems(avms, m, 0); });
}
function actionsTooltip(onWhat, actionsOpen) {
    if (actionsOpen) {
        return __WEBPACK_IMPORTED_MODULE_3__user_messages__["_79" /* closeActions */];
    }
    return onWhat.disableActions() ? __WEBPACK_IMPORTED_MODULE_3__user_messages__["_80" /* noActions */] : __WEBPACK_IMPORTED_MODULE_3__user_messages__["_81" /* openActions */];
}
function getCollectionDetails(count) {
    if (count == null) {
        return __WEBPACK_IMPORTED_MODULE_3__user_messages__["_82" /* unknownCollectionSize */];
    }
    if (count === 0) {
        return __WEBPACK_IMPORTED_MODULE_3__user_messages__["_83" /* emptyCollectionSize */];
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_models_action_view_model__ = __webpack_require__(389);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models__ = __webpack_require__(5);
...
var ActionComponent = (function () {
    function ActionComponent(myElement, context) {
        this.myElement = myElement;
        this.context = context;
    }
    Object.defineProperty(ActionComponent.prototype, "description", {
        get: function () {
    ...
    Object.defineProperty(ActionComponent.prototype, "friendlyName", {
        get: function () {
    ...
    ActionComponent.prototype.displayClass = function () {
        return ({
    ...
    ActionComponent.prototype.isObjectContext = function () {
        return this.action.actionRep.parent instanceof __WEBPACK_IMPORTED_MODULE_3__models__["o" /* DomainObjectRepresentation */];
    };
    ActionComponent.prototype.isCollectionContext = function () {
        return this.action.actionRep.parent instanceof __WEBPACK_IMPORTED_MODULE_3__models__["A" /* CollectionMember */];
    };
    ...
    ActionComponent.prototype.doInvoke = function (right) {
    ...
    __decorate([
        ...
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__view_models_action_view_model__["a" /* ActionViewModel */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__view_models_action_view_model__["a" /* ActionViewModel */]) === 'function' && _a) || Object)
    ...
    ActionComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__context_service__["a" /* ContextService */]) === 'function' && _c) || Object])
    ], ActionComponent);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__ = __webpack_require__(40);
...
var ApplicationPropertiesComponent = (function () {
    function ApplicationPropertiesComponent(viewModelFactory) {
        this.viewModelFactory = viewModelFactory;
    }
    ...
    ApplicationPropertiesComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__["a" /* ViewModelFactoryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__["a" /* ViewModelFactoryService */]) === 'function' && _a) || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_model_factory_service__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pane_pane__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__config_service__ = __webpack_require__(16);
            ...
            if (attachment) {
                ...
                if (avm) {
                    ...
                    avm.downloadFile()
                        ...
                        reader.onloadend = function () { return _this.image = reader.result; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cicero_renderer_service__ = __webpack_require__(173);
...
var Command = (function () {
    ...
    Command.prototype.execute = function (argString, chained, cvm) {
        ...
        if (!this.isAvailableInCurrentContext()) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["u" /* commandNotAvailable */](this.fullCommand));
            return;
        }
        //TODO: This could be moved into a pre-parse method as it does not depend on context
        if (argString == null) {
            if (this.minArguments > 0) {
                this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["v" /* noArguments */]);
                return;
            }
        }
        else {
            ...
            if (args.length < this.minArguments) {
                this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["w" /* tooFewArguments */]);
                return;
            }
            else if (args.length > this.maxArguments) {
                this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["x" /* tooManyArguments */]);
                return;
            }
        }
    ...
    Command.prototype.mayNotBeChained = function (rider) {
        ...
        this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["y" /* mayNotbeChainedMessage */](this.fullCommand, rider));
    };
    ...
    Command.prototype.checkMatch = function (matchText) {
        if (this.fullCommand.indexOf(matchText) !== 0) {
            throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["z" /* noSuchCommand */](matchText));
        }
    };
    //argNo starts from 0.
    ...
    Command.prototype.argumentAsString = function (argString, argNo, optional, toLower) {
        ...
        if (!optional && argString.split(",").length < argNo + 1) {
            throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["w" /* tooFewArguments */]);
        }
        var args = argString.split(",");
        if (args.length < argNo + 1) {
            if (optional) {
                ...
                throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["A" /* missingArgument */](argNo + 1));
            }
        }
    ...
    Command.prototype.argumentAsNumber = function (args, argNo, optional) {
        ...
        if (isNaN(number)) {
            throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["B" /* wrongTypeArgument */](argNo + 1));
        }
        return number;
    };
    Command.prototype.parseInt = function (input) {
        ...
        if (isNaN(number)) {
            throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["C" /* isNotANumber */](input));
        }
        return number;
    };
    ...
    Command.prototype.parseRange = function (arg) {
        ...
        switch (clauses.length) {
            ...
            case 2:
                ...
                break;
            default:
                throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["D" /* tooManyDashes */]);
        }
        if ((range.start != null && range.start < 1) || (range.end != null && range.end < 1)) {
            throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["E" /* mustBeGreaterThanZero */]);
        }
        return range;
    };
    ...
    Command.prototype.handleErrorResponse = function (err, getFriendlyName) {
        ...
        var msg = __WEBPACK_IMPORTED_MODULE_1__user_messages__["F" /* pleaseCompleteOrCorrect */];
    ...
    Command.prototype.fieldValidationMessage = function (errorValue, fieldFriendlyName) {
        ...
        if (reason) {
            ...
            if (reason === __WEBPACK_IMPORTED_MODULE_1__user_messages__["d" /* mandatory */]) {
                msg += __WEBPACK_IMPORTED_MODULE_1__user_messages__["G" /* required */];
            }
            else {
                msg += value + " " + reason;
            }
...
var Action = (function (_super) {
    ...
    function Action() {
        ...
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["H" /* actionCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["I" /* actionHelp */];
        this.minArguments = 0;
        this.maxArguments = 2;
    }
    ...
    Action.prototype.doExecute = function (args, chained) {
        ...
        if (details && details !== "?") {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["J" /* mustbeQuestionMark */]);
            return;
        }
        if (this.isObject()) {
            this.getObject()
    ...
    Action.prototype.processActions = function (match, actionsMap, details) {
        ...
        if (actions.length === 0) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["K" /* noActionsAvailable */]);
            return;
        }
        if (match) {
        ...
        switch (actions.length) {
            case 0:
                this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["L" /* doesNotMatchActions */](match));
                break;
            case 1:
                ...
                break;
            default:
                var output = match ? __WEBPACK_IMPORTED_MODULE_1__user_messages__["M" /* matchingActions */] : __WEBPACK_IMPORTED_MODULE_1__user_messages__["N" /* actionsMessage */];
                output += this.listActions(actions);
                this.clearInputAndSetMessage(output);
        }
    };
    Action.prototype.disabledAction = function (action) {
        var output = __WEBPACK_IMPORTED_MODULE_1__user_messages__["O" /* actionPrefix */] + " " + action.extensions().friendlyName() + " " + __WEBPACK_IMPORTED_MODULE_1__user_messages__["P" /* isDisabled */] + " " + action.disabledReason();
        this.clearInputAndSetMessage(output);
    };
    Action.prototype.listActions = function (actions) {
        return _.reduce(actions, function (s, t) {
            ...
            var disabled = t.disabledReason() ? " (" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["Q" /* disabledPrefix */] + " " + t.disabledReason() + ")" : "";
    ...
    Action.prototype.renderActionDetails = function (action) {
        var s = __WEBPACK_IMPORTED_MODULE_1__user_messages__["R" /* descriptionPrefix */] + " " + action.extensions().friendlyName() + "\n" + (action.extensions().description() || __WEBPACK_IMPORTED_MODULE_1__user_messages__["S" /* noDescription */]);
...
var Back = (function (_super) {
    ...
    function Back() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["T" /* backCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["U" /* backHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Cancel = (function (_super) {
    ...
    function Cancel() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["V" /* cancelCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["W" /* cancelHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Clipboard = (function (_super) {
    ...
    function Clipboard() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["X" /* clipboardCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["Y" /* clipboardHelp */];
        this.minArguments = 1;
        this.maxArguments = 1;
    }
    ...
    Clipboard.prototype.doExecute = function (args, chained) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["Z" /* clipboardCopy */].indexOf(sub) === 0) {
            this.copy();
        }
        else if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["_0" /* clipboardShow */].indexOf(sub) === 0) {
            this.show();
        }
        else if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["_1" /* clipboardGo */].indexOf(sub) === 0) {
            this.go();
        }
        else if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["_2" /* clipboardDiscard */].indexOf(sub) === 0) {
            this.discard();
        }
        else {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_3" /* clipboardError */]);
        }
    };
    ;
    Clipboard.prototype.copy = function () {
        var _this = this;
        if (!this.isObject()) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_4" /* clipboardContextError */]);
            return;
        }
        this.getObject().
            then(function (obj) {
    ...
    Clipboard.prototype.show = function () {
        if (this.cvm.clipboard) {
            ...
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_5" /* clipboardContents */](label));
        }
        else {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_6" /* clipboardEmpty */]);
        }
    };
...
var Edit = (function (_super) {
    ...
    function Edit() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_7" /* editCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_8" /* editHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Enter = (function (_super) {
    ...
    function Enter() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_9" /* enterCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_10" /* enterHelp */];
        this.minArguments = 2;
        this.maxArguments = 2;
    }
    ...
    Enter.prototype.fieldEntryForEdit = function (fieldName, fieldEntry) {
        ...
        this.getObject().
            ...
            switch (fields.length) {
                case 0:
                    s = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_11" /* doesNotMatchProperties */](fieldName);
                    break;
                case 1:
                    var field = fields[0];
                    if (fieldEntry === "?") {
                    ...
                    break;
                default:
                    s = fieldName + " " + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_12" /* matchesMultiple */];
    ...
    Enter.prototype.fieldEntryForDialog = function (fieldName, fieldEntry) {
        ...
        this.getActionForCurrentDialog().
            ...
            switch (params.length) {
                case 0:
                    _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_13" /* doesNotMatchDialog */](fieldName));
                    break;
                case 1:
                    if (fieldEntry === "?") {
                        var p = params[0];
                    ...
                    break;
                default:
                    _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_14" /* multipleFieldMatches */] + " " + fieldName); //TODO: list them
                    break;
            }
        }).
            catch(function (reject) { return _this.error.handleError(reject); });
    ...
    Enter.prototype.setField = function (field, fieldEntry) {
        if (field instanceof __WEBPACK_IMPORTED_MODULE_0__models__["l" /* PropertyMember */] && field.disabledReason()) {
            this.clearInputAndSetMessage(field.extensions().friendlyName() + " " + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_15" /* isNotModifiable */]);
            return;
        }
        ...
        switch (entryType) {
            ...
            case __WEBPACK_IMPORTED_MODULE_0__models__["h" /* EntryType */].MultipleConditionalChoices:
                ...
                return;
            default:
                throw new Error(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_16" /* invalidCase */]);
        }
    };
    ...
    Enter.prototype.handleReferenceField = function (field, fieldEntry) {
        if (this.isPaste(fieldEntry)) {
            ...
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_17" /* invalidRefEntry */]);
        }
    };
    ...
    Enter.prototype.handleClipboard = function (field) {
        ...
        if (!ref) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_18" /* emptyClipboard */]);
            return;
        }
        ...
        this.context.isSubTypeOf(refType, paramType).
            ...
            if (isSubType) {
                ...
                _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_19" /* incompatibleClipboard */]);
            }
        }).
            catch(function (reject) { return _this.error.handleError(reject); });
    };
    ...
    Enter.prototype.switchOnMatches = function (field, fieldEntry, matches) {
        switch (matches.length) {
            case 0:
                this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_20" /* noMatch */](fieldEntry));
                break;
            case 1:
                this.setFieldValue(field, matches[0]);
                break;
            default:
                var msg_1 = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_21" /* multipleMatches */];
    ...
    Enter.prototype.renderFieldDetails = function (field, value) {
        var s = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_22" /* fieldName */](field.extensions().friendlyName());
        var desc = field.extensions().description();
        s += desc ? "\n" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_23" /* descriptionFieldPrefix */] + " " + desc : "";
        s += "\n" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_24" /* typePrefix */] + " " + __WEBPACK_IMPORTED_MODULE_0__models__["p" /* friendlyTypeName */](field.extensions().returnType());
        if (field instanceof __WEBPACK_IMPORTED_MODULE_0__models__["l" /* PropertyMember */] && field.disabledReason()) {
            s += "\n" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_25" /* unModifiablePrefix */](field.disabledReason());
        }
        else {
            s += field.extensions().optional() ? "\n" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_26" /* optional */] : "\n" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["d" /* mandatory */];
            if (field.choices()) {
                var label = "\n" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_27" /* choices */] + ": ";
...
var Forward = (function (_super) {
    ...
    function Forward() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_28" /* forwardCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_29" /* forwardHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Gemini = (function (_super) {
    ...
    function Gemini() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_30" /* geminiCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_31" /* geminiHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Goto = (function (_super) {
    ...
    function Goto() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_32" /* gotoCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_33" /* gotoHelp */];
        this.minArguments = 1;
        this.maxArguments = 1;
    }
            ...
            this.getObject().
                ...
                if (_this.isCollection()) {
                    ...
                    switch (matchingRefProps.length + matchingColls.length) {
                        case 0:
                            s = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_34" /* noRefFieldMatch */](arg0);
                            break;
                        case 1:
    ...
    Goto.prototype.attemptGotoLinkNumber = function (itemNo, links) {
        if (itemNo < 1 || itemNo > links.length) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_35" /* outOfItemRange */](itemNo));
        }
        else {
...
var Help = (function (_super) {
    ...
    function Help() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_36" /* helpCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_37" /* helpHelp */];
        this.minArguments = 0;
        this.maxArguments = 1;
    }
    ...
    Help.prototype.doExecute = function (args, chained) {
        ...
        if (!arg) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_38" /* basicHelp */]);
        }
        else if (arg === "?") {
...
var Menu = (function (_super) {
    ...
    function Menu() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_39" /* menuCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_40" /* menuHelp */];
        this.minArguments = 0;
        this.maxArguments = 1;
    }
    ...
    Menu.prototype.doExecute = function (args, chained) {
        ...
        this.context.getMenus()
            ...
            switch (links.length) {
                case 0:
                    _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_41" /* doesNotMatchMenu */](name));
                    break;
                case 1:
                    ...
                    break;
                default:
                    var label = name ? __WEBPACK_IMPORTED_MODULE_1__user_messages__["_42" /* matchingMenus */] + "\n" : __WEBPACK_IMPORTED_MODULE_1__user_messages__["_43" /* allMenus */] + "\n";
...
var OK = (function (_super) {
    ...
    function OK() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_44" /* okCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_45" /* okHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
    ...
    OK.prototype.doExecute = function (args, chained) {
        ...
        this.getActionForCurrentDialog().
            ...
            if (chained && action.invokeLink().method() !== "GET") {
                _this.mayNotBeChained(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_46" /* queryOnlyRider */]);
                return;
            }
            var fieldMap;
            if (_this.isForm()) {
...
var Page = (function (_super) {
    ...
    function Page() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_47" /* pageCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_48" /* pageHelp */];
        this.minArguments = 1;
        this.maxArguments = 1;
    }
    ...
    Page.prototype.doExecute = function (args, chained) {
        ...
        this.getList().
            ...
            if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["_49" /* pageFirst */].indexOf(arg) === 0) {
                _this.setPage(1);
                return;
            }
            else if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["_50" /* pagePrevious */].indexOf(arg) === 0) {
                if (page === 1) {
                    _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_51" /* alreadyOnFirst */]);
                }
                else {
                    _this.setPage(page - 1);
                }
            }
            else if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["_52" /* pageNext */].indexOf(arg) === 0) {
                if (page === numPages) {
                    _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_53" /* alreadyOnLast */]);
                }
                else {
                    _this.setPage(page + 1);
                }
            }
            else if (__WEBPACK_IMPORTED_MODULE_1__user_messages__["_54" /* pageLast */].indexOf(arg) === 0) {
                _this.setPage(numPages);
            }
            else {
                var number = parseInt(arg);
                if (isNaN(number)) {
                    _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_55" /* pageArgumentWrong */]);
                    return;
                }
                if (number < 1 || number > numPages) {
                    _this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_56" /* pageNumberWrong */](numPages));
                    return;
                }
...
var Reload = (function (_super) {
    ...
    function Reload() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_57" /* reloadCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_58" /* reloadHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Root = (function (_super) {
    ...
    function Root() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_59" /* rootCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_60" /* rootHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Save = (function (_super) {
    ...
    function Save() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_61" /* saveCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_62" /* saveHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
var Selection = (function (_super) {
    ...
    function Selection() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_63" /* selectionCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_64" /* selectionHelp */];
        this.minArguments = 1;
        this.maxArguments = 1;
    }
...
var Show = (function (_super) {
    ...
    function Show() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_65" /* showCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_66" /* showHelp */];
        this.minArguments = 0;
        this.maxArguments = 1;
    }
        ...
        if (this.isCollection()) {
            ...
            this.getObject().
                ...
                switch (props.length + colls.length) {
                    case 0:
                        s = fieldName_1 ? __WEBPACK_IMPORTED_MODULE_1__user_messages__["_67" /* doesNotMatch */](fieldName_1) : __WEBPACK_IMPORTED_MODULE_1__user_messages__["_68" /* noVisible */];
                        break;
                    case 1:
    ...
    Show.prototype.renderPropNameAndValue = function (pm) {
        ...
        if (this.isEdit() && !pm.disabledReason() && modifiedValue) {
            value = __WEBPACK_IMPORTED_MODULE_2__cicero_renderer_service__["d" /* renderFieldValue */](pm, modifiedValue, this.mask) + (" (" + __WEBPACK_IMPORTED_MODULE_1__user_messages__["_69" /* modified */] + ")");
        }
        else {
    ...
    Show.prototype.renderItems = function (source, startNo, endNo) {
        ...
        if (startNo > max || endNo > max) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_70" /* highestItem */](source.value().length));
            return;
        }
        if (startNo > endNo) {
            this.clearInputAndSetMessage(__WEBPACK_IMPORTED_MODULE_1__user_messages__["_71" /* startHigherEnd */]);
            return;
        }
        var output = "";
        var i;
        ...
        for (i = startNo; i <= endNo; i++) {
            output += __WEBPACK_IMPORTED_MODULE_1__user_messages__["t" /* item */] + " " + i + ": " + links[i - 1].title() + "\n";
        }
        this.clearInputAndSetMessage(output);
    };
    return Show;
...
var Where = (function (_super) {
    ...
    function Where() {
        _super.apply(this, arguments);
        this.fullCommand = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_72" /* whereCommand */];
        this.helpText = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_73" /* whereHelp */];
        this.minArguments = 0;
        this.maxArguments = 0;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cicero_command_factory_service__ = __webpack_require__(249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__cicero_renderer_service__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__view_models_cicero_view_model__ = __webpack_require__(700);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__url_manager_service__ = __webpack_require__(17);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__custom_component_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__logger_service__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__url_manager_service__ = __webpack_require__(17);
...
var DynamicErrorComponent = (function () {
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_6" /* ViewChild */])('parent', { read: __WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* ViewContainerRef */] }), 
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* ViewContainerRef */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* ViewContainerRef */]) === 'function' && _a) || Object)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pane_pane__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__config_service__ = __webpack_require__(16);
...
var DynamicListComponent = (function (_super) {
    ...
    Object.defineProperty(DynamicListComponent.prototype, "buttons", {
        get: function () {
    ...
    DynamicListComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__context_service__["a" /* ContextService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_7__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__error_service__["a" /* ErrorService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["X" /* ComponentFactoryResolver */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["X" /* ComponentFactoryResolver */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1__custom_component_service__["a" /* CustomComponentService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__custom_component_service__["a" /* CustomComponentService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_9__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_9__config_service__["a" /* ConfigService */]) === 'function' && _h) || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pane_pane__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__config_service__ = __webpack_require__(16);
...
var DynamicObjectComponent = (function (_super) {
    ...
    DynamicObjectComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["X" /* ComponentFactoryResolver */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["X" /* ComponentFactoryResolver */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__custom_component_service__["a" /* CustomComponentService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__custom_component_service__["a" /* CustomComponentService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_7__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__config_service__["a" /* ConfigService */]) === 'function' && _f) || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__field_field_component__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__view_models_parameter_view_model__ = __webpack_require__(254);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__view_models_dialog_view_model__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__logger_service__ = __webpack_require__(72);
...
var EditParameterComponent = (function (_super) {
    ...
    function EditParameterComponent(viewModelFactory, urlManager, myElement, context, configService, loggerService) {
        _super.call(this, myElement, context, configService, loggerService);
        this.viewModelFactory = viewModelFactory;
        this.urlManager = urlManager;
    ...
    EditParameterComponent.prototype.droppableClasses = function () {
    ...
    EditParameterComponent.prototype.onEnter = function (event) {
        this.paste(event);
    };
    EditParameterComponent.prototype.onEnter1 = function (event) {
        this.paste(event);
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
        __metadata('design:type', (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormGroup */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormGroup */]) === 'function' && _d) || Object), 
        __metadata('design:paramtypes', [(typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormGroup */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormGroup */]) === 'function' && _e) || Object])
    ], EditParameterComponent.prototype, "form", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])('keydown', ['$event']), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], EditParameterComponent.prototype, "onEnter", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])('keypress', ['$event']), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], EditParameterComponent.prototype, "onEnter1", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])("focus"), 
        __metadata('design:type', (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */]) === 'function' && _f) || Object)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__field_field_component__ = __webpack_require__(381);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__view_models_property_view_model__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__view_models_domain_object_view_model__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__logger_service__ = __webpack_require__(72);
...
var EditPropertyComponent = (function (_super) {
    ...
    function EditPropertyComponent(myElement, router, error, context, configService, loggerService) {
        _super.call(this, myElement, context, configService, loggerService);
        this.router = router;
        this.error = error;
    }
    ...
    EditPropertyComponent.prototype.onEnter = function (event) {
        this.paste(event);
    };
    EditPropertyComponent.prototype.onEnter1 = function (event) {
        this.paste(event);
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
        __metadata('design:type', (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormGroup */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormGroup */]) === 'function' && _d) || Object), 
        __metadata('design:paramtypes', [(typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormGroup */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormGroup */]) === 'function' && _e) || Object])
    ...
    __decorate([
        ...
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], EditPropertyComponent.prototype, "onEnter", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])('keypress', ['$event']), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], EditPropertyComponent.prototype, "onEnter1", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])("focus"), 
        __metadata('design:type', (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */]) === 'function' && _f) || Object)
    ...
    EditPropertyComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]) === 'function' && _h) || Object, (typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_4__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__error_service__["a" /* ErrorService */]) === 'function' && _j) || Object, (typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_5__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__context_service__["a" /* ContextService */]) === 'function' && _k) || Object, (typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_8__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__config_service__["a" /* ConfigService */]) === 'function' && _l) || Object, (typeof (_m = typeof __WEBPACK_IMPORTED_MODULE_9__logger_service__["a" /* LoggerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_9__logger_service__["a" /* LoggerService */]) === 'function' && _m) || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_models_choice_view_model__ = __webpack_require__(73);
...
var FieldComponent = (function () {
    function FieldComponent(myElement, context, configService, loggerService) {
        this.context = context;
        this.configService = configService;
        this.loggerService = loggerService;
        this.currentOptions = [];
    ...
    FieldComponent.prototype.isInside = function (clickedComponent) {
        if (clickedComponent) {
    ...
    FieldComponent.prototype.focus = function () {
        ...
        if (this.focusList && this.focusList.first) {
            setTimeout(function () { return _this.focusList.first.nativeElement.focus(); }, 0);
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_model_factory_service__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pane_pane__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__color_service__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__view_model_factory_service__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__logger_service__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__view_models_helpers_view_models__ = __webpack_require__(28);
...
var ListComponent = (function () {
    function ListComponent(activatedRoute, urlManager, context, color, viewModelFactory, error, configService, loggerService) {
        ...
        this.itemTableTitle = function (item) { return item.tableRowViewModel.title; };
        this.itemHasTableTitle = function (item) { return item.tableRowViewModel.showTitle; };
        this.itemTableProperties = function (item) { return item.tableRowViewModel.properties; };
        ...
        this.itemId = function (i) { return ("item" + _this.collection.onPaneId + "-" + i); };
        this.itemColor = function (item) { return item.color; };
        this.itemSelected = function (item) { return item.selected; };
        this.itemTitle = function (item) { return item.title; };
        this.doItemClick = function (item, right) { return item.doClick(right); };
        this.title = "";
        this.state = "list";
    }
    ...
    Object.defineProperty(ListComponent.prototype, "buttons", {
        get: function () {
    ...
    ListComponent.prototype.setup = function (routeData) {
        ...
        if (this.collection && this.collection.id === listKey) {
            ...
            this.state = __WEBPACK_IMPORTED_MODULE_6__route_data__["b" /* CollectionViewState */][routeData.state].toString().toLowerCase();
    ...
    ListComponent.prototype.copy = function (event, item) {
        __WEBPACK_IMPORTED_MODULE_11__view_models_helpers_view_models__["m" /* copy */](event, item, this.context);
    };
    ListComponent.prototype.focusOnRow = function (e) {
        if (e && e.first) {
    ...
    ListComponent.prototype.ngAfterViewInit = function () {
        ...
        this.row.changes.subscribe(function (ql) { return _this.focusOnRow(ql); });
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])("rw"), 
    ...
    ], ListComponent.prototype, "row", void 0);
    ListComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* ActivatedRoute */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__context_service__["a" /* ContextService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__color_service__["a" /* ColorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__color_service__["a" /* ColorService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_7__view_model_factory_service__["a" /* ViewModelFactoryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__view_model_factory_service__["a" /* ViewModelFactoryService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_5__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__error_service__["a" /* ErrorService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_9__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_9__config_service__["a" /* ConfigService */]) === 'function' && _h) || Object, (typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_10__logger_service__["a" /* LoggerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_10__logger_service__["a" /* LoggerService */]) === 'function' && _j) || Object])
    ], ListComponent);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_models_link_view_model__ = __webpack_require__(253);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__url_manager_service__ = __webpack_require__(17);
...
var MenuComponent = (function () {
    function MenuComponent(urlManager, elementRef) {
        this.urlManager = urlManager;
        this.elementRef = elementRef;
    }
    MenuComponent.prototype.ngOnInit = function () {
    };
    MenuComponent.prototype.doClick = function () {
        var menuId = this.menu.link.rel().parms[0].value;
        this.urlManager.setMenu(menuId, this.menu.paneId);
    };
    Object.defineProperty(MenuComponent.prototype, "title", {
        get: function () {
    ...
    MenuComponent.prototype.focus = function () {
        this.elementRef.nativeElement.children[0].focus();
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__view_models_link_view_model__["a" /* LinkViewModel */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__view_models_link_view_model__["a" /* LinkViewModel */]) === 'function' && _a) || Object)
    ...
    MenuComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */]) === 'function' && _c) || Object])
    ], MenuComponent);
    return MenuComponent;
    var _a, _b, _c;
}());
//# sourceMappingURL=C:/projects/nakedobjectsframework-7b999/Spa2/nakedobjectsspa/src/menu.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pane_pane__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_model_factory_service__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__context_service__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__view_models_helpers_view_models__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_lodash__ = __webpack_require__(8);
...
var MultiLineDialogComponent = (function (_super) {
    ...
    function MultiLineDialogComponent(activatedRoute, urlManager, viewModelFactory, context, error, formBuilder, configService) {
        ...
        this.rowMessage = function (row) {
            return row.submitted ? __WEBPACK_IMPORTED_MODULE_10__user_messages__["_94" /* submittedMessage */] : row.getMessage();
        };
    ...
    Object.defineProperty(MultiLineDialogComponent.prototype, "count", {
        get: function () {
            return __WEBPACK_IMPORTED_MODULE_10__user_messages__["_95" /* submittedCount */](this.dialog.submittedCount());
        },
        enumerable: true,
        configurable: true
    });
    MultiLineDialogComponent.prototype.invokeAndAdd = function (index) {
        ...
        __WEBPACK_IMPORTED_MODULE_12_lodash__["forEach"](parms, function (p) {
    ...
    MultiLineDialogComponent.prototype.createForm = function (dialog) {
        return __WEBPACK_IMPORTED_MODULE_9__view_models_helpers_view_models__["l" /* createForm */](dialog, this.formBuilder);
    };
    MultiLineDialogComponent.prototype.setMultiLineDialog = function (holder, newDialogId, routeData, actionViewModel) {
        ...
        this.context.getInvokableAction(action).
            ...
            _this.rowData = __WEBPACK_IMPORTED_MODULE_12_lodash__["map"](_this.dialog.dialogs, function (d) { return _this.createForm(d); });
        }).
            catch(function (reject) { return _this.error.handleError(reject); });
    };
    MultiLineDialogComponent.prototype.setup = function (routeData) {
        ...
        if (routeData.menuId) {
            ...
            var oid = __WEBPACK_IMPORTED_MODULE_11__models__["d" /* ObjectIdWrapper */].fromObjectId(routeData.objectId, this.configService.config.keySeparator);
            this.context.getObject(routeData.paneId, oid, routeData.interactionMode).
                then(function (object) {
                var ovm = _this.viewModelFactory.domainObjectViewModel(object, routeData, false);
                var newDialogId = routeData.dialogId;
                var lcaCollection = __WEBPACK_IMPORTED_MODULE_12_lodash__["find"](ovm.collections, function (c) { return c.hasMatchingLocallyContributedAction(newDialogId); });
                if (lcaCollection) {
                    var actionViewModel = __WEBPACK_IMPORTED_MODULE_12_lodash__["find"](lcaCollection.actions, function (a) { return a.actionRep.actionId() === newDialogId; });
    ...
    MultiLineDialogComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* ActivatedRoute */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__view_model_factory_service__["a" /* ViewModelFactoryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__view_model_factory_service__["a" /* ViewModelFactoryService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__context_service__["a" /* ContextService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__error_service__["a" /* ErrorService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_7__angular_forms__["c" /* FormBuilder */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__angular_forms__["c" /* FormBuilder */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_8__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__config_service__["a" /* ConfigService */]) === 'function' && _g) || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_model_factory_service__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_forms__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__color_service__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__view_models_helpers_view_models__ = __webpack_require__(28);
...
var ObjectComponent = (function () {
    function ObjectComponent(activatedRoute, urlManager, context, viewModelFactory, colorService, error, formBuilder, configService) {
        ...
        this.pendingColor = "object-color0";
    ...
    ObjectComponent.prototype.copy = function (event) {
        var obj = this.object;
        if (obj) {
            __WEBPACK_IMPORTED_MODULE_13__view_models_helpers_view_models__["m" /* copy */](event, obj, this.context);
        }
    };
    ObjectComponent.prototype.title = function () {
        var obj = this.object;
        var prefix = this.mode === __WEBPACK_IMPORTED_MODULE_7__route_data__["a" /* InteractionMode */].Edit || this.mode === __WEBPACK_IMPORTED_MODULE_7__route_data__["a" /* InteractionMode */].Transient ? __WEBPACK_IMPORTED_MODULE_12__user_messages__["p" /* editing */] + " - " : "";
    ...
    Object.defineProperty(ObjectComponent.prototype, "buttons", {
        get: function () {
            ...
            if (this.mode === __WEBPACK_IMPORTED_MODULE_7__route_data__["a" /* InteractionMode */].Form) {
                ...
                if (!this.actionButtons) {
                    ...
                    this.actionButtons = __WEBPACK_IMPORTED_MODULE_9_lodash__["map"](actions, function (a) { return ({
                        value: a.title,
                        doClick: function () {
                            return a.doInvoke();
                        },
                        doRightClick: function () {
                            return a.doInvoke(true);
                        },
                        show: function () { return true; },
    ...
    ObjectComponent.prototype.focusOnTitle = function (e) {
        if (this.mode === __WEBPACK_IMPORTED_MODULE_7__route_data__["a" /* InteractionMode */].View) {
            if (e && e.first) {
                setTimeout(function () { return e.first.nativeElement.focus(); }, 0);
            }
        }
    };
    ...
    ObjectComponent.prototype.ngAfterViewInit = function () {
        ...
        this.titleDiv.changes.subscribe(function (ql) { return _this.focusOnTitle(ql); });
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])("ttl"), 
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */]) === 'function' && _a) || Object)
    ], ObjectComponent.prototype, "titleDiv", void 0);
    ObjectComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* ActivatedRoute */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__context_service__["a" /* ContextService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__view_model_factory_service__["a" /* ViewModelFactoryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__view_model_factory_service__["a" /* ViewModelFactoryService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_10__color_service__["a" /* ColorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_10__color_service__["a" /* ColorService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_6__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__error_service__["a" /* ErrorService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* FormBuilder */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* FormBuilder */]) === 'function' && _h) || Object, (typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_11__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_11__config_service__["a" /* ConfigService */]) === 'function' && _j) || Object])
    ], ObjectComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pane_pane__ = __webpack_require__(97);
...
var RecentComponent = (function (_super) {
    ...
    function RecentComponent(activatedRoute, urlManager, viewModelFactory) {
        ...
        this.viewModelFactory = viewModelFactory;
        // template API 
        this.title = "Recently Viewed Objects";
        this.items = function () { return _this.recent.items; };
        // todo again a smell - new child component ! 
        this.itemColor = function (item) { return item.color; };
        this.itemTitle = function (item) { return item.title; };
        this.itemFriendlyName = function (item) { return item.friendlyName; };
        this.doItemClick = function (item, right) { return item.doClick(right); };
        this.clearButton = {
            value: "Clear",
            ...
            title: function () { return "Clear history"; },
            accesskey: "c"
        };
    }
    Object.defineProperty(RecentComponent.prototype, "buttons", {
        get: function () {
    ...
    RecentComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__["a" /* ViewModelFactoryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__["a" /* ViewModelFactoryService */]) === 'function' && _c) || Object])
    ], RecentComponent);
            ...
            : function (right) {
                ...
                _this.parameters()
                    ...
                    if (actionResult.shouldExpectResult() && !actionResult.warningsOrMessages()) {
                        _this.context.broadcastWarning(__WEBPACK_IMPORTED_MODULE_2__user_messages__["_85" /* noResultMessage */]);
                    }
                })
                    .catch(function (reject) {
                    _this.decrementPendingPotentAction();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__user_messages__ = __webpack_require__(23);
...
var AttachmentViewModel = (function () {
    function AttachmentViewModel(link, parent, context, urlManager, clickHandler, onPaneId) {
        var _this = this;
        this.link = link;
        this.parent = parent;
        this.context = context;
        ...
        this.doClick = function (right) { return _this.urlManager.setAttachment(_this.link, _this.clickHandler.pane(_this.onPaneId, right)); };
        this.href = link.href();
        this.mimeType = link.type().asString;
        this.title = link.title() || __WEBPACK_IMPORTED_MODULE_0__user_messages__["_93" /* unknownFileTitle */];
    }
...
var ContributedActionParentViewModel = (function (_super) {
            ...
            var rejectAsNeedSelection = function (action) {
                if (_this.isLocallyContributed(action)) {
                    if (selected.length === 0) {
                        var em = new __WEBPACK_IMPORTED_MODULE_1__models__["w" /* ErrorMap */]({}, 0, __WEBPACK_IMPORTED_MODULE_2__user_messages__["_84" /* noItemsSelected */]);
    ...
    ContributedActionParentViewModel.prototype.collectionContributedInvokeDecorator = function (actionViewModel) {
        ...
        var invokeWithDialog = function (right) {
            _this.context.clearDialogCachedValues(_this.onPaneId);
        ...
        var invokeWithoutDialog = function (right) {
            return actionViewModel.execute([], right).
                then(function (result) {
                _this.setMessage(result.shouldExpectResult() ? result.warningsOrMessages() || __WEBPACK_IMPORTED_MODULE_2__user_messages__["_85" /* noResultMessage */] : "");
                // clear selected items on void actions 
                _this.clearSelected(result);
            }).
                catch(function (reject) {
    ...
    ContributedActionParentViewModel.prototype.setItems = function (newValue) {
        __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](this.items, function (item) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__link_view_model__ = __webpack_require__(253);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_view_models__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__contributed_action_parent_view_model__ = __webpack_require__(391);
...
var ListViewModel = (function (_super) {
    ...
    function ListViewModel(colorService, context, viewModelFactory, urlManager, error, loggerService, list, routeData) {
        ...
        this.updateItems = function (value) {
            ...
            _this.size = count;
            if (count > 0) {
                _this.description = function () { return __WEBPACK_IMPORTED_MODULE_3__user_messages__["_89" /* pageMessage */](_this.page, _this.numPages, count, totalCount); };
            }
            else {
                _this.description = function () { return __WEBPACK_IMPORTED_MODULE_3__user_messages__["_90" /* noItemsFound */]; };
            }
        };
        ...
        this.showActions = function () {
            return !!_this.urlManager.getRouteData().pane(_this.onPaneId).actionsOpen;
        };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__message_view_model__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_view_models__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__color_service__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__click_handler_service__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__mask_service__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__view_models_attachment_view_model__ = __webpack_require__(390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__view_models_error_view_model__ = __webpack_require__(702);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__view_models_link_view_model__ = __webpack_require__(253);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__view_models_item_view_model__ = __webpack_require__(392);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__view_models_recent_item_view_model__ = __webpack_require__(706);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__view_models_table_row_column_view_model__ = __webpack_require__(708);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__view_models_table_row_view_model__ = __webpack_require__(709);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__view_models_collection_placeholder_view_model__ = __webpack_require__(701);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__view_models_recent_items_view_model__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__view_models_parameter_view_model__ = __webpack_require__(254);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__view_models_action_view_model__ = __webpack_require__(389);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__view_models_property_view_model__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__view_models_collection_view_model__ = __webpack_require__(252);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__view_models_menu_view_model__ = __webpack_require__(394);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__view_models_menus_view_model__ = __webpack_require__(704);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23_lodash__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__view_models_list_view_model__ = __webpack_require__(393);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__view_models_dialog_view_model__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__view_models_domain_object_view_model__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__view_models_multi_line_dialog_view_model__ = __webpack_require__(705);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__logger_service__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__view_models_application_properties_view_model__ = __webpack_require__(699);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__cicero_command_factory_service__ = __webpack_require__(249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__cicero_renderer_service__ = __webpack_require__(173);
...
var ViewModelFactoryService = (function () {
    function ViewModelFactoryService(context, urlManager, color, error, clickHandler, mask, configService, loggerService, commandFactory, ciceroRenderer) {
        ...
        this.attachmentViewModel = function (propertyRep, paneId) {
            ...
            if (link) {
                var parent = propertyRep.parent;
                return new __WEBPACK_IMPORTED_MODULE_8__view_models_attachment_view_model__["a" /* AttachmentViewModel */](link, parent, _this.context, _this.urlManager, _this.clickHandler, paneId);
            }
            return null;
        };
        ...
        this.actionViewModel = function (actionRep, vm, routeData) {
            return new __WEBPACK_IMPORTED_MODULE_18__view_models_action_view_model__["a" /* ActionViewModel */](_this, _this.context, _this.urlManager, _this.error, _this.clickHandler, actionRep, vm, routeData);
        };
        ...
        this.propertyViewModel = function (propertyRep, id, previousValue, paneId, parentValues) {
            return new __WEBPACK_IMPORTED_MODULE_19__view_models_property_view_model__["a" /* PropertyViewModel */](propertyRep, _this.color, _this.error, _this, _this.context, _this.mask, _this.urlManager, _this.clickHandler, _this.configService, id, previousValue, paneId, parentValues);
        };
        this.dialogViewModel = function (routeData, action, actionViewModel, isRow) {
            return new __WEBPACK_IMPORTED_MODULE_25__view_models_dialog_view_model__["a" /* DialogViewModel */](_this.color, _this.context, _this, _this.urlManager, _this.error, routeData, action, actionViewModel, isRow);
        };
        this.multiLineDialogViewModel = function (routeData, action, holder) {
            return new __WEBPACK_IMPORTED_MODULE_27__view_models_multi_line_dialog_view_model__["a" /* MultiLineDialogViewModel */](_this.color, _this.context, _this, _this.urlManager, _this.error, routeData, action, holder);
        };
        this.domainObjectViewModel = function (obj, routeData, forceReload) {
            var ovm = new __WEBPACK_IMPORTED_MODULE_26__view_models_domain_object_view_model__["a" /* DomainObjectViewModel */](_this.color, _this.context, _this, _this.urlManager, _this.error, _this.configService, obj, routeData, forceReload);
            if (forceReload) {
        ...
        this.listViewModel = function (list, routeData) {
            return new __WEBPACK_IMPORTED_MODULE_24__view_models_list_view_model__["a" /* ListViewModel */](_this.color, _this.context, _this, _this.urlManager, _this.error, _this.loggerService, list, routeData);
        };
        this.parameterViewModel = function (parmRep, previousValue, paneId) {
            return new __WEBPACK_IMPORTED_MODULE_17__view_models_parameter_view_model__["a" /* ParameterViewModel */](parmRep, paneId, _this.color, _this.error, _this.mask, previousValue, _this, _this.context, _this.configService);
        };
        this.collectionViewModel = function (collectionRep, routeData, forceReload) {
            return new __WEBPACK_IMPORTED_MODULE_20__view_models_collection_view_model__["a" /* CollectionViewModel */](_this, _this.color, _this.error, _this.context, _this.urlManager, _this.configService, _this.loggerService, collectionRep, routeData, forceReload);
        };
        this.listPlaceholderViewModel = function (routeData) {
            return new __WEBPACK_IMPORTED_MODULE_15__view_models_collection_placeholder_view_model__["a" /* CollectionPlaceholderViewModel */](_this.context, _this.error, routeData);
        };
        this.menuViewModel = function (menuRep, routeData) {
            return new __WEBPACK_IMPORTED_MODULE_21__view_models_menu_view_model__["a" /* MenuViewModel */](_this, menuRep, routeData);
        };
        this.menusViewModel = function (menusRep, routeData) {
            return new __WEBPACK_IMPORTED_MODULE_22__view_models_menus_view_model__["a" /* MenusViewModel */](_this, menusRep, routeData.paneId);
        };
        this.recentItemsViewModel = function (paneId) {
            return new __WEBPACK_IMPORTED_MODULE_16__view_models_recent_items_view_model__["a" /* RecentItemsViewModel */](_this, _this.context, _this.urlManager, paneId);
        };
        ...
        this.applicationPropertiesViewModel = function () { return new __WEBPACK_IMPORTED_MODULE_30__view_models_application_properties_view_model__["a" /* ApplicationPropertiesViewModel */](_this.context, _this.error, _this.configService); };
        this.getItems = function (links, tableView, routeData, listViewModel) {
            var collection = listViewModel instanceof __WEBPACK_IMPORTED_MODULE_20__view_models_collection_view_model__["a" /* CollectionViewModel */] ? listViewModel : null;
            var id = collection ? collection.id : "";
            var selectedItems = routeData.selectedCollectionItems[id];
            var items = __WEBPACK_IMPORTED_MODULE_23_lodash__["map"](links, function (link, i) { return _this.itemViewModel(link, routeData.paneId, selectedItems && selectedItems[i], i, id); });
            if (tableView) {
                ...
                var getExtensions = listViewModel instanceof __WEBPACK_IMPORTED_MODULE_20__view_models_collection_view_model__["a" /* CollectionViewModel */] ? function () { return Promise.resolve(listViewModel.collectionRep.extensions()); } : getActionExtensions;
                // clear existing header 
                listViewModel.header = null;
                if (items.length > 0) {
                    getExtensions().
                        then(function (ext) {
                        __WEBPACK_IMPORTED_MODULE_23_lodash__["forEach"](items, function (itemViewModel) {
                        ...
                        if (!listViewModel.header) {
                            ...
                            var propertiesHeader = __WEBPACK_IMPORTED_MODULE_23_lodash__["map"](firstItem_1.properties, function (p, i) {
                                var match = __WEBPACK_IMPORTED_MODULE_23_lodash__["find"](items, function (item) { return item.tableRowViewModel.properties[i].title; });
    ...
    ViewModelFactoryService = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__context_service__["a" /* ContextService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__color_service__["a" /* ColorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__color_service__["a" /* ColorService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__error_service__["a" /* ErrorService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__click_handler_service__["a" /* ClickHandlerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__click_handler_service__["a" /* ClickHandlerService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6__mask_service__["a" /* MaskService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__mask_service__["a" /* MaskService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_28__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_28__config_service__["a" /* ConfigService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_29__logger_service__["a" /* LoggerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_29__logger_service__["a" /* LoggerService */]) === 'function' && _h) || Object, (typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_31__cicero_command_factory_service__["a" /* CiceroCommandFactoryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_31__cicero_command_factory_service__["a" /* CiceroCommandFactoryService */]) === 'function' && _j) || Object, (typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_32__cicero_renderer_service__["a" /* CiceroRendererService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_32__cicero_renderer_service__["a" /* CiceroRendererService */]) === 'function' && _k) || Object])
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash__);
...
function getDate(val) {
    var dt1 = __WEBPACK_IMPORTED_MODULE_3_moment__(val, "YYYY-MM-DD", "en-GB", true);
    if (dt1.isValid()) {
        return dt1.toDate();
    }
    return null;
...
var ErrorWrapper = (function () {
    function ErrorWrapper(category, code, err, originalUrl) {
        ...
        if (category === ErrorCategory.ClientError) {
            ...
            var description = __WEBPACK_IMPORTED_MODULE_1__user_messages__["e" /* errorUnknown */];
            switch (this.clientErrorCode) {
                case ClientErrorCode.ExpiredTransient:
                    description = __WEBPACK_IMPORTED_MODULE_1__user_messages__["f" /* errorExpiredTransient */];
                    break;
                case ClientErrorCode.WrongType:
                    description = __WEBPACK_IMPORTED_MODULE_1__user_messages__["g" /* errorWrongType */];
                    break;
                case ClientErrorCode.NotImplemented:
                    description = __WEBPACK_IMPORTED_MODULE_1__user_messages__["h" /* errorNotImplemented */];
                    break;
                case ClientErrorCode.SoftwareError:
                    description = __WEBPACK_IMPORTED_MODULE_1__user_messages__["i" /* errorSoftware */];
                    break;
                case ClientErrorCode.ConnectionProblem:
                    description = __WEBPACK_IMPORTED_MODULE_1__user_messages__["j" /* errorConnection */];
                    break;
            }
            this.description = description;
            this.title = __WEBPACK_IMPORTED_MODULE_1__user_messages__["k" /* errorClient */];
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__action_action_component__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__(5);
...
var ActionsComponent = (function () {
    function ActionsComponent() {
        ...
        this.menuActions = function (menuItem) { return menuItem.actions; };
        this.toggleCollapsed = function (menuItem) { return menuItem.toggleCollapsed(); };
    ...
    Object.defineProperty(ActionsComponent.prototype, "items", {
        get: function () {
    ...
    ActionsComponent.prototype.displayContextClass = function () {
        return ({
            objectContext: this.isObjectContext(),
            collectionContext: this.isCollectionContext()
        });
    };
    ActionsComponent.prototype.isObjectContext = function () {
        return this.firstAction && this.firstAction.actionRep.parent instanceof __WEBPACK_IMPORTED_MODULE_2__models__["o" /* DomainObjectRepresentation */];
    };
    ActionsComponent.prototype.isCollectionContext = function () {
        return this.firstAction && this.firstAction.actionRep.parent instanceof __WEBPACK_IMPORTED_MODULE_2__models__["A" /* CollectionMember */];
    };
    ActionsComponent.prototype.focusOnFirstAction = function (actions) {
        if (actions && actions.first) {
            actions.first.focus();
        }
    };
    ActionsComponent.prototype.findFirstAction = function (menuItems) {
        for (var _i = 0, menuItems_1 = menuItems; _i < menuItems_1.length; _i++) {
            var mi = menuItems_1[_i];
    ...
    ], ActionsComponent.prototype, "menu", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])(__WEBPACK_IMPORTED_MODULE_1__action_action_component__["a" /* ActionComponent */]), 
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */]) === 'function' && _a) || Object)
    ], ActionsComponent.prototype, "actionChildren", void 0);
...
//# sourceMappingURL=C:/projects/nakedobjectsframework-7b999/Spa2/nakedobjectsspa/src/actions.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_home_component__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recent_recent_component__ = __webpack_require__(387);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__application_properties_application_properties_component__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__attachment_attachment_component__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__multi_line_dialog_multi_line_dialog_component__ = __webpack_require__(385);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__dynamic_object_dynamic_object_component__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__dynamic_list_dynamic_list_component__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__dynamic_error_dynamic_error_component__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__cicero_cicero_component__ = __webpack_require__(373);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_routing_module__ = __webpack_require__(681);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_component__ = __webpack_require__(682);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__footer_footer_component__ = __webpack_require__(691);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__home_home_component__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__object_object_component__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__list_list_component__ = __webpack_require__(383);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__error_error_component__ = __webpack_require__(380);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__actions_actions_component__ = __webpack_require__(680);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__action_action_component__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__properties_properties_component__ = __webpack_require__(697);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__collections_collections_component__ = __webpack_require__(688);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__dialog_dialog_component__ = __webpack_require__(689);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__parameters_parameters_component__ = __webpack_require__(696);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__edit_property_edit_property_component__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__view_property_view_property_component__ = __webpack_require__(711);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__edit_parameter_edit_parameter_component__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__recent_recent_component__ = __webpack_require__(387);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__application_properties_application_properties_component__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__gemini_click_directive__ = __webpack_require__(694);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__gemini_boolean_directive__ = __webpack_require__(692);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__gemini_clear_directive__ = __webpack_require__(693);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__url_manager_service__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__click_handler_service__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__rep_loader_service__ = __webpack_require__(251);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__view_model_factory_service__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__color_service__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__mask_service__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__collection_collection_component__ = __webpack_require__(687);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34_ng2_dnd__ = __webpack_require__(896);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__attachment_attachment_component__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__multi_line_dialog_multi_line_dialog_component__ = __webpack_require__(385);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__view_parameter_view_parameter_component__ = __webpack_require__(710);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__error_handler__ = __webpack_require__(690);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__menus_menus_component__ = __webpack_require__(695);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__menu_menu_component__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__buttons_buttons_component__ = __webpack_require__(686);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__button_button_component__ = __webpack_require__(685);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__dynamic_object_dynamic_object_component__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__custom_component_service__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__custom_component_config_service__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__dynamic_list_dynamic_list_component__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__logger_service__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__attachment_property_attachment_property_component__ = __webpack_require__(684);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__dynamic_error_dynamic_error_component__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__cicero_cicero_component__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__cicero_command_factory_service__ = __webpack_require__(249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__cicero_renderer_service__ = __webpack_require__(173);
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__actions_actions_component__["a" /* ActionsComponent */],
                __WEBPACK_IMPORTED_MODULE_12__action_action_component__["a" /* ActionComponent */],
                __WEBPACK_IMPORTED_MODULE_13__properties_properties_component__["a" /* PropertiesComponent */],
                __WEBPACK_IMPORTED_MODULE_14__collections_collections_component__["a" /* CollectionsComponent */],
                __WEBPACK_IMPORTED_MODULE_15__dialog_dialog_component__["a" /* DialogComponent */],
                __WEBPACK_IMPORTED_MODULE_16__parameters_parameters_component__["a" /* ParametersComponent */],
                __WEBPACK_IMPORTED_MODULE_17__edit_property_edit_property_component__["a" /* EditPropertyComponent */],
                __WEBPACK_IMPORTED_MODULE_18__view_property_view_property_component__["a" /* ViewPropertyComponent */],
                __WEBPACK_IMPORTED_MODULE_19__edit_parameter_edit_parameter_component__["a" /* EditParameterComponent */],
                __WEBPACK_IMPORTED_MODULE_20__recent_recent_component__["a" /* RecentComponent */],
                __WEBPACK_IMPORTED_MODULE_21__application_properties_application_properties_component__["a" /* ApplicationPropertiesComponent */],
                __WEBPACK_IMPORTED_MODULE_22__gemini_click_directive__["a" /* GeminiClickDirective */],
                __WEBPACK_IMPORTED_MODULE_23__gemini_boolean_directive__["a" /* GeminiBooleanDirective */],
                __WEBPACK_IMPORTED_MODULE_24__gemini_clear_directive__["a" /* GeminiClearDirective */],
                __WEBPACK_IMPORTED_MODULE_33__collection_collection_component__["a" /* CollectionComponent */],
                __WEBPACK_IMPORTED_MODULE_35__attachment_attachment_component__["a" /* AttachmentComponent */],
                __WEBPACK_IMPORTED_MODULE_36__multi_line_dialog_multi_line_dialog_component__["a" /* MultiLineDialogComponent */],
                __WEBPACK_IMPORTED_MODULE_37__view_parameter_view_parameter_component__["a" /* ViewParameterComponent */],
                __WEBPACK_IMPORTED_MODULE_39__menus_menus_component__["a" /* MenusComponent */],
                __WEBPACK_IMPORTED_MODULE_40__menu_menu_component__["a" /* MenuComponent */],
                __WEBPACK_IMPORTED_MODULE_41__buttons_buttons_component__["a" /* ButtonsComponent */],
                __WEBPACK_IMPORTED_MODULE_42__button_button_component__["a" /* ButtonComponent */],
                __WEBPACK_IMPORTED_MODULE_43__dynamic_object_dynamic_object_component__["a" /* DynamicObjectComponent */],
                __WEBPACK_IMPORTED_MODULE_46__dynamic_list_dynamic_list_component__["a" /* DynamicListComponent */],
                __WEBPACK_IMPORTED_MODULE_49__attachment_property_attachment_property_component__["a" /* AttachmentPropertyComponent */],
                __WEBPACK_IMPORTED_MODULE_50__dynamic_error_dynamic_error_component__["a" /* DynamicErrorComponent */],
                __WEBPACK_IMPORTED_MODULE_51__cicero_cicero_component__["a" /* CiceroComponent */]
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_8__object_object_component__["a" /* ObjectComponent */],
                __WEBPACK_IMPORTED_MODULE_9__list_list_component__["a" /* ListComponent */],
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_27__url_manager_service__["a" /* UrlManagerService */],
                __WEBPACK_IMPORTED_MODULE_28__click_handler_service__["a" /* ClickHandlerService */],
                __WEBPACK_IMPORTED_MODULE_26__context_service__["a" /* ContextService */],
                __WEBPACK_IMPORTED_MODULE_29__rep_loader_service__["a" /* RepLoaderService */],
                __WEBPACK_IMPORTED_MODULE_30__view_model_factory_service__["a" /* ViewModelFactoryService */],
                __WEBPACK_IMPORTED_MODULE_31__color_service__["a" /* ColorService */],
                __WEBPACK_IMPORTED_MODULE_25__error_service__["a" /* ErrorService */],
                __WEBPACK_IMPORTED_MODULE_32__mask_service__["a" /* MaskService */],
                __WEBPACK_IMPORTED_MODULE_44__custom_component_service__["a" /* CustomComponentService */],
                // to configure custom components create implementation of ICustomComponentConfigService and bind in here
                { provide: __WEBPACK_IMPORTED_MODULE_45__custom_component_config_service__["a" /* CustomComponentConfigService */], useClass: __WEBPACK_IMPORTED_MODULE_45__custom_component_config_service__["a" /* CustomComponentConfigService */] },
                __WEBPACK_IMPORTED_MODULE_48__logger_service__["a" /* LoggerService */],
                __WEBPACK_IMPORTED_MODULE_47__config_service__["a" /* ConfigService */],
                __WEBPACK_IMPORTED_MODULE_52__cicero_command_factory_service__["a" /* CiceroCommandFactoryService */],
                __WEBPACK_IMPORTED_MODULE_53__cicero_renderer_service__["a" /* CiceroRendererService */],
                { provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["c" /* ErrorHandler */], useClass: __WEBPACK_IMPORTED_MODULE_38__error_handler__["a" /* GeminiErrorHandler */] },
                { provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["d" /* APP_INITIALIZER */], useFactory: __WEBPACK_IMPORTED_MODULE_47__config_service__["b" /* configFactory */], deps: [__WEBPACK_IMPORTED_MODULE_47__config_service__["a" /* ConfigService */]], multi: true },
                { provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["e" /* LOCALE_ID */], useFactory: __WEBPACK_IMPORTED_MODULE_47__config_service__["c" /* localeFactory */], deps: [__WEBPACK_IMPORTED_MODULE_47__config_service__["a" /* ConfigService */]] }
            ],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_models_attachment_view_model__ = __webpack_require__(390);
...
var AttachmentPropertyComponent = (function () {
    function AttachmentPropertyComponent(error, router) {
        var _this = this;
        this.error = error;
        this.router = router;
        this.doAttachmentClick = function (right) { return _this.attachment.doClick(right); };
    }
    ...
    AttachmentPropertyComponent.prototype.clickHandler = function (attachment) {
        var _this = this;
        return function () {
            if (!attachment.displayInline()) {
                attachment.downloadFile()
                    ...
                    if (window.navigator.msSaveBlob) {
                        ...
                        _this.router.navigateByUrl(burl);
                    }
                })
                    .catch(function (reject) { return _this.error.handleError(reject); });
            }
...
var ButtonComponent = (function () {
    ...
    ButtonComponent.prototype.doRightClick = function () {
        if (this.button.doRightClick) {
            this.button.doRightClick();
        }
    };
    ButtonComponent.prototype.show = function () {
    ...
    Object.defineProperty(ButtonComponent.prototype, "title", {
        get: function () {
...
//# sourceMappingURL=C:/projects/nakedobjectsframework-7b999/Spa2/nakedobjectsspa/src/button.component.js.map
...
var ButtonsComponent = (function () {
    ...
    ], ButtonsComponent.prototype, "buttons", void 0);
...
//# sourceMappingURL=C:/projects/nakedobjectsframework-7b999/Spa2/nakedobjectsspa/src/buttons.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__route_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_models_collection_view_model__ = __webpack_require__(252);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__url_manager_service__ = __webpack_require__(17);
...
var CollectionComponent = (function () {
    function CollectionComponent(urlManager) {
        ...
        this.noItems = function () { return !_this.collection.items || _this.collection.items.length === 0; };
        this.allSelected = function () { return _this.collection.allSelected(); };
        this.selectAll = function () { return _this.collection.selectAll(); };
        this.hasTableData = function () { return _this.collection.hasTableData(); };
        this.itemColor = function (item) { return item.color; };
        this.itemTitle = function (item) { return item.title; };
        this.doItemClick = function (item, right) { return item.doClick(right); };
        this.itemId = function (i) { return ("" + _this.collection.id + _this.collection.onPaneId + "-" + i); };
        this.itemTableTitle = function (item) { return item.tableRowViewModel.title; };
        this.itemHasTableTitle = function (item) { return item.tableRowViewModel.showTitle; };
        this.itemTableProperties = function (item) { return item.tableRowViewModel.properties; };
        this.propertyType = function (property) { return property.type; };
    ...
    Object.defineProperty(CollectionComponent.prototype, "state", {
        get: function () {
            return __WEBPACK_IMPORTED_MODULE_1__route_data__["b" /* CollectionViewState */][this.collection.currentState].toString().toLowerCase();
        },
        enumerable: true,
        configurable: true
    });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_forms__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__view_models_list_view_model__ = __webpack_require__(393);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__view_models_menu_view_model__ = __webpack_require__(394);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__view_models_domain_object_view_model__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__view_models_collection_view_model__ = __webpack_require__(252);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__config_service__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__view_models_helpers_view_models__ = __webpack_require__(28);
...
var DialogComponent = (function () {
    ...
    DialogComponent.prototype.createForm = function (dialog) {
        (_a = __WEBPACK_IMPORTED_MODULE_14__view_models_helpers_view_models__["l" /* createForm */](dialog, this.formBuilder), this.form = _a.form, this.dialog = _a.dialog, this.parms = _a.parms, _a);
        var _a;
    };
    ...
    DialogComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__["a" /* ViewModelFactoryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__view_model_factory_service__["a" /* ViewModelFactoryService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["c" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__angular_router__["c" /* ActivatedRoute */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_7__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__error_service__["a" /* ErrorService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__context_service__["a" /* ContextService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_13__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_13__config_service__["a" /* ConfigService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* FormBuilder */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* FormBuilder */]) === 'function' && _g) || Object])
    ], DialogComponent);
...
var GeminiErrorHandler = (function () {
    ...
    GeminiErrorHandler.prototype.handleError = function (error) {
        // todo make safer 
        var ec = error.context || error.rejection.context;
        if (ec) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__rep_loader_service__ = __webpack_require__(251);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__config_service__ = __webpack_require__(16);
...
var FooterComponent = (function () {
    function FooterComponent(urlManager, context, clickHandler, error, repLoader, location, configService, http) {
        var _this = this;
        this.urlManager = urlManager;
        this.context = context;
        this.clickHandler = clickHandler;
        ...
        this.logOff = function () {
            _this.context.getUser()
                .then(function (u) {
                if (window.confirm(__WEBPACK_IMPORTED_MODULE_8__user_messages__["_96" /* logOffMessage */](u.userName() || "Unknown"))) {
                    var args = {
                        withCredentials: true
                    };
                    // logoff server
                    ...
                    window.location.href = _this.configService.config.postLogoffUrl;
                }
            })
                .catch(function (reject) { return _this.error.handleError(reject); });
        };
    ...
    FooterComponent.prototype.ngOnInit = function () {
        ...
        this.repLoader.loadingCount$.subscribe(function (count) { return _this.loading = count > 0 ? __WEBPACK_IMPORTED_MODULE_8__user_messages__["_97" /* loadingMessage */] : ""; });
    ...
    FooterComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__url_manager_service__["a" /* UrlManagerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__url_manager_service__["a" /* UrlManagerService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__context_service__["a" /* ContextService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__context_service__["a" /* ContextService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__click_handler_service__["a" /* ClickHandlerService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_4__click_handler_service__["a" /* ClickHandlerService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__error_service__["a" /* ErrorService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__error_service__["a" /* ErrorService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_7__rep_loader_service__["a" /* RepLoaderService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__rep_loader_service__["a" /* RepLoaderService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_common__["c" /* Location */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_common__["c" /* Location */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_9__config_service__["a" /* ConfigService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_9__config_service__["a" /* ConfigService */]) === 'function' && _g) || Object, (typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */]) === 'function' && _h) || Object])
    ], FooterComponent);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_models_field_view_model__ = __webpack_require__(180);
...
var GeminiBooleanDirective = (function () {
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])('geminiBoolean'), 
    ...
    GeminiBooleanDirective = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Directive */])({ selector: '[geminiBoolean]' }), 
        __metadata('design:paramtypes', [(typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Renderer */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Renderer */]) === 'function' && _d) || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_models_field_view_model__ = __webpack_require__(180);
...
var GeminiClearDirective = (function () {
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])('geminiClear'), 
    ...
    __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormGroup */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormGroup */]) === 'function' && _d) || Object])
    ], GeminiClearDirective.prototype, "form", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])("click", ['$event']), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], GeminiClearDirective.prototype, "click", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])("touchstart", ['$event']), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], GeminiClearDirective.prototype, "touchstart", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])("mousemove", ['$event']), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', [Object]), 
        __metadata('design:returntype', void 0)
    ], GeminiClearDirective.prototype, "mousemove", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])("input"), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', []), 
        __metadata('design:returntype', void 0)
    ], GeminiClearDirective.prototype, "input", null);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])("change"), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', []), 
        __metadata('design:returntype', void 0)
    ], GeminiClearDirective.prototype, "change", null);
    GeminiClearDirective = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Directive */])({ selector: '[geminiClear]' }), 
        __metadata('design:paramtypes', [(typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* ElementRef */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Renderer */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Renderer */]) === 'function' && _f) || Object])
...
var GeminiClickDirective = (function () {
    function GeminiClickDirective(el) {
        this.leftClick = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* EventEmitter */]();
        this.rightClick = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["H" /* EventEmitter */]();
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_0" /* HostListener */])('contextmenu'), 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', []), 
        __metadata('design:returntype', void 0)
    ], GeminiClickDirective.prototype, "onContextMenu", null);
    GeminiClickDirective = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Directive */])({ selector: '[geminiClick]' }), 
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__menu_menu_component__ = __webpack_require__(384);
...
var MenusComponent = (function () {
    ...
    MenusComponent.prototype.focusOnFirstMenu = function (menusList) {
    ...
    MenusComponent.prototype.ngAfterViewInit = function () {
        ...
        this.menuComponents.changes.subscribe(function (ql) { return _this.focusOnFirstMenu(ql); });
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
        __metadata('design:type', Array)
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])(__WEBPACK_IMPORTED_MODULE_1__menu_menu_component__["a" /* MenuComponent */]), 
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */]) === 'function' && _a) || Object)
    ], MenusComponent.prototype, "menuComponents", void 0);
...
//# sourceMappingURL=C:/projects/nakedobjectsframework-7b999/Spa2/nakedobjectsspa/src/menus.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_parameter_edit_parameter_component__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view_models_dialog_view_model__ = __webpack_require__(178);
...
var ParametersComponent = (function () {
    ...
    ParametersComponent.prototype.focusOnFirstAction = function (parms) {
        if (parms && parms.first) {
            parms.first.focus();
        }
    };
    ParametersComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.focusOnFirstAction(this.parmComponents);
        this.parmComponents.changes.subscribe(function (ql) { return _this.focusOnFirstAction(ql); });
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])(__WEBPACK_IMPORTED_MODULE_2__edit_parameter_edit_parameter_component__["a" /* EditParameterComponent */]), 
        __metadata('design:type', (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */]) === 'function' && _c) || Object)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_property_edit_property_component__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view_models_domain_object_view_model__ = __webpack_require__(179);
...
var PropertiesComponent = (function () {
    ...
    PropertiesComponent.prototype.focusOnFirstProperty = function (prop) {
        if (prop && prop.first) {
            prop.first.focus();
        }
    };
    PropertiesComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.focusOnFirstProperty(this.propComponents);
        this.propComponents.changes.subscribe(function (ql) { return _this.focusOnFirstProperty(ql); });
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* ViewChildren */])(__WEBPACK_IMPORTED_MODULE_2__edit_property_edit_property_component__["a" /* EditPropertyComponent */]), 
        __metadata('design:type', (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* QueryList */]) === 'function' && _c) || Object)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__rxjs_extensions__ = __webpack_require__(177);
...
var CiceroViewModel = (function () {
    function CiceroViewModel() {
        this.alert = ""; //Alert is appended before the output
        this.outputSource = new __WEBPACK_IMPORTED_MODULE_0_rxjs_Subject__["Subject"]();
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CollectionPlaceholderViewModel; });
var CollectionPlaceholderViewModel = (function () {
    function CollectionPlaceholderViewModel(context, error, routeData) {
        var _this = this;
        this.context = context;
        this.error = error;
        this.routeData = routeData;
        // todo string constants in user messages !
        this.description = function () { return ("Page " + _this.routeData.page); };
        this.recreate = function () {
            return _this.routeData.objectId ? _this.context.getListFromObject(_this.routeData) : _this.context.getListFromMenu(_this.routeData);
        };
        this.reload = function () {
...
//# sourceMappingURL=C:/projects/nakedobjectsframework-7b999/Spa2/nakedobjectsspa/src/collection-placeholder-view-model.js.map
...
var MenuItemViewModel = (function () {
    function MenuItemViewModel(name, actions, // modified todo 
        menuItems // modified todo 
        ) {
        var _this = this;
        this.name = name;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__item_view_model__ = __webpack_require__(392);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_messages__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_view_models__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
            ...
            if (propertyRep instanceof __WEBPACK_IMPORTED_MODULE_2__models__["l" /* PropertyMember */]) {
                ...
                if (propertyRep.isScalar()) {
                    ...
                    if (propertyRep.entryType() === __WEBPACK_IMPORTED_MODULE_2__models__["h" /* EntryType */].Choices) {
                        ...
                        this.formattedValue = __WEBPACK_IMPORTED_MODULE_1__user_messages__["_92" /* obscuredText */];
                    }
                    else {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_models_parameter_view_model__ = __webpack_require__(254);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_models_dialog_view_model__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__error_service__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__context_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__view_models_property_view_model__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_models_helpers_view_models__ = __webpack_require__(28);
...
var ViewPropertyComponent = (function () {
    ...
    ViewPropertyComponent.prototype.copy = function (event) {
        ...
        if (prop) {
            __WEBPACK_IMPORTED_MODULE_5__view_models_helpers_view_models__["m" /* copy */](event, prop, this.context);
        }
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* Input */])(), 
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_service__ = __webpack_require__(16);
...
// module
exports.push([module.i, ".multiline {\n    overflow: auto;\n}\n\n.reference {\n    cursor: pointer;\n}", ""]);
...
module.exports = "<div class=\"name\" tabindex=\"0\" title=\"{{description}}\" geminiClick (leftClick)=\"doInvoke()\" (rightClick)=\"doInvoke(true)\" [attr.disabled]=\"disabled()\" [ngClass]=\"displayClass()\">\n    {{friendlyName}}\n</div>\n\n"
...
module.exports = "<div class=\"\" [ngClass]=\"displayContextClass()\">\n    <div *ngFor=\"let menu of items\">\n\n        <div *ngIf=\"menuName(menu)\" (click)=\"toggleCollapsed(menu)\" tabindex=\"0\" class=\"submenu\" [ngSwitch]=\"navCollapsed(menu)\">\n            {{menuName(menu)}}\n            <div *ngSwitchCase=\"true\" class=\"icon-expand\"></div>\n            <div *ngSwitchCase=\"false\" class=\"icon-collapse\"></div>\n        </div>\n        <div class=\"\" [ngClass]=\"displayClass(menu)\">\n            <div *ngIf=\"menuActions(menu)  && menuActions(menu).length > 0\">\n                <div *ngFor=\"let action of menuActions(menu)\">\n                    <nof-action [action]=\"action\"></nof-action>\n                </div>\n            </div>\n            <div *ngIf=\"menuItems(menu) && menuItems(menu).length > 0\">\n                <nof-actions [menu]=\"menu\"></nof-actions>\n            </div>\n        </div>\n    </div>\n</div>"
...
module.exports = "<input tabindex=\"0\" type=\"button\" geminiClick (leftClick)=\"doClick()\" [value]=\"value\" [attr.disabled]=\"disabled()\"\n    *ngIf=\"show()\" [title]=\"title\">"
...
module.exports = "\n<nof-button *ngFor=\"let button of buttons\" [button]=\"button\"></nof-button>\n\n"
...
module.exports = "<div tabindex=\"0\" class=\"name\" geminiClick (leftClick)=\"doClick()\">{{title}}</div>\n"
...
module.exports = "<nof-menu *ngFor=\"let menu of menus\" [menu]=\"menu\"></nof-menu>\n"
...
module.exports = "<div  *ngIf=\"form\"><nof-edit-parameter  [ngClass]=\"classes()\" *ngFor=\"let parm of parameters\" [parameter]=\"parm\" [parent]=\"parent\" [form]=\"form\"></nof-edit-parameter></div>\n<div *ngIf=\"!form\"><nof-view-parameter [ngClass]=\"classes()\" *ngFor=\"let parm of parameters\" [parameter]=\"parm\" [parent]=\"parent\"></nof-view-parameter></div>"
...
module.exports = "<div *ngIf=\"form\"><nof-edit-property class=\"property\" *ngFor=\"let prop of properties\" [property]=\"prop\" [parent]=\"parent\" [form]=\"form\"></nof-edit-property></div>\n<div *ngIf=\"!form\"><nof-view-property class=\"property\" *ngFor=\"let prop of properties\" [property]=\"prop\"></nof-view-property></div>\n\n"
...
module.exports = "<div [attr.id]=\"paneIdName\" [ngClass]=\"paneType\">\n    <div class=\"recent\">\n        <div class=\"header\">\n            <div class=\"title\">{{title}}</div>\n            <nof-buttons [buttons]=\"buttons\"></nof-buttons>\n        </div>\n        <div *ngIf=\"recent\">\n            <table>\n                <tbody>\n                    <tr [ngClass]=\"itemColor(item)\" *ngFor=\"let item of items()\" dnd-draggable [dragEnabled]=\"true\" [dragData]=\"item\" geminiClick\n                        (leftClick)=\"doItemClick(item)\" (rightClick)=\"doItemClick(item, true)\">\n                        <td tabindex=\"0\" class=\"cell\">\n                            {{itemTitle(item)}}\n                        </td>\n                        <td tabindex=\"0\" class=\"cell\">\n                            {{itemFriendlyName(item)}}\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n    </div>\n</div>\n<router-outlet (activate)=\"onChild()\" (deactivate)=\"onChildless()\"></router-outlet>\n"
