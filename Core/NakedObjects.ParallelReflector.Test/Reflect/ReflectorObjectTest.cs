...
namespace NakedObjects.ParallelReflect.Test {
    ...
    public class ReflectorObjectTest : AbstractReflectorTest {
        protected override (ITypeSpecBuilder, IImmutableDictionary<string, ITypeSpecBuilder>) LoadSpecification(ParallelReflector reflector) {
            ...
            return reflector.IntrospectSpecification(typeof(TestDomainObject), metamodel, () => new Introspector(reflector, reflector.ObjectFacetFactorySet, ClassStrategy, null));
        }
