...
public static class PropertyDetailsApi {
    public static async Task<PropertyDetails> SetValue(this PropertyDetails propertyRepresentation, object newValue, IInvokeOptions? options = null) {
    ...
    public static async Task<IEnumerable<T?>> GetPrompts<T>(this PropertyDetails propertyRepresentation, IInvokeOptions options, params object[] pp) {
    ...
    public static async Task<IEnumerable<Link>> GetLinkPrompts(this PropertyDetails propertyRepresentation, IInvokeOptions options, params object[] pp) {
        var prompt = await ApiHelpers.GetPrompt(propertyRepresentation, options, pp);
