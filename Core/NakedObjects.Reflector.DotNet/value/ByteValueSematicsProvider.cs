...
namespace NakedObjects.Reflector.DotNet.Value {
    public class ByteValueSemanticsProvider : ValueSemanticsProviderAbstract<byte>, IPropertyDefaultFacet, IByteValueFacet {
        ...
        /// </summary>
        public ByteValueSemanticsProvider(INakedObjectReflector reflector)
            : this(reflector, null) {}

        public ByteValueSemanticsProvider(INakedObjectReflector reflector, IFacetHolder holder)
