...
// Type: org.nakedobjects.object.reflect.internal.InternalSpecification
...
namespace org.nakedobjects.@object.reflect.@internal
{
  ...
  public class InternalSpecification : NakedObjectSpecification
  {
    ...
    private InternalSpecification.SubclassList subclasses;
    ...
    {
      this.introspector = new InternalIntrospector(cls, builder);
      this.subclasses = new InternalSpecification.SubclassList(this);
      this.persistable = Persistable.TRANSIENT;
    }
...
label_10:
      ...
      int noParameters)
    {
      ...
      for (int index = 0; index < availableActions.Length; ++index)
      {
        ...
        if (availableAction.getType().Equals((object) type) && (noParameters == -1 || availableAction.getParameterTypes().Length == noParameters))
...
label_8:
    ...
    public virtual NakedObjectField[] getVisibleFields(NakedObject @object) => this.getFields();

    public virtual NakedObjectField[] getAccessibleFields() => this.getFields();

    public virtual NakedObjectField[] getAccessibleFieldsForCollectiveView() => this.getFields();
    ...
    public virtual void introspect()
    {
      ...
      if (superclass != null)
      {
        ...
        if (this.superclass != null)
        {
          if (InternalSpecification.LOG.isDebugEnabled())
            InternalSpecification.LOG.debug((object) new StringBuffer().append("  Superclass ").append(superclass).ToString());
      ...
      this.introspector = (InternalIntrospector) null;
    }
    ...
    public override string ToString()
    {
      ...
      toString.append("object", this.isObject);
      toString.append("collection", this.isCollection);
      toString.append("value", this.isValue);
      return toString.ToString();
    }

    [EditorBrowsable(EditorBrowsableState.Never)]
    [JavaFlags(32778)]
    static InternalSpecification()
    {
    ...
    {
      InternalSpecification internalSpecification = this;
      ObjectImpl.clone((object) internalSpecification);
      return ((object) internalSpecification).MemberwiseClone();
    }
    ...
    private class SubclassList
    {
      ...
      [JavaFlags(32770)]
      [EditorBrowsable(EditorBrowsableState.Never)]
      private InternalSpecification this\u00240;
      ...
      [JavaFlags(2)]
      public SubclassList(InternalSpecification _param1)
      {
        this.this\u00240 = _param1;
        if (_param1 == null)
      ...
      public new virtual object MemberwiseClone()
      {
        InternalSpecification.SubclassList subclassList = this;
