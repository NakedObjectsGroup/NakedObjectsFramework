...
namespace MvcTestApp.Tests.Controllers {
    ...
    public class HomeControllerTest : AcceptanceTestCase {
        ...
        private string EmployeeId {
            get { return Surface.OidTranslator.GetOidTranslation(Surface.GetObject(Employee)).Encode(); }
        }

        private string VendorId {
            get { return Surface.OidTranslator.GetOidTranslation(Surface.GetObject(Vendor)).Encode(); }
        }
        ...
        public void ClearAllHistory() {
            mocks.HttpContext.Object.Session.AddToCache(Surface, Employee, ObjectCache.ObjectFlag.BreadCrumb);
        ...
        public void ClearHistoryItemNext1() {
            mocks.HttpContext.Object.Session.AddToCache(Surface, Employee, ObjectCache.ObjectFlag.BreadCrumb);
            mocks.HttpContext.Object.Session.AddToCache(Surface, Vendor, ObjectCache.ObjectFlag.BreadCrumb);
