...
// Type: org.nakedobjects.viewer.cli.field.SelectReferenceToSetFieldDispatcher
...
namespace org.nakedobjects.viewer.cli.field
{
  ...
  public class SelectReferenceToSetFieldDispatcher : Dispatcher
  {
    public virtual void execute(Command command, Context context, View view)
    {
      ...
      agent.setReferenceField(context, view, associate);
    }

    public virtual string getHelp() => "Adds the current object to the collection for the field previously specified";
    ...
    {
      SelectReferenceToSetFieldDispatcher setFieldDispatcher = this;
