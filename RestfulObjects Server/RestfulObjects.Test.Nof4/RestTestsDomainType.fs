    ...
    class
        ...
        override x.MenuServices = 
            box (new ServicesInstaller([| box (new RestDataRepository())
                                          box (new WithActionService()) |])) :?> IServicesInstaller : IServicesInstaller
        
        override x.SystemServices = 
            box (new ServicesInstaller([| box (new TestTypeCodeMapper())
                                          box (new TestKeyCodeMapper()) |])) :?> IServicesInstaller : IServicesInstaller
        
        override x.ContributedActions = box (new ServicesInstaller([| box (new ContributorService()) |])) :?> IServicesInstaller : IServicesInstaller
