...
// Type: org.nakedobjects.object.persistence.TopDownPersistAlgorithm
...
namespace org.nakedobjects.@object.persistence
{
  ...
  public class TopDownPersistAlgorithm : PersistAlgorithm
  {
    ...
    public Oid createOid(Naked @object)
    {
      ...
      if (TopDownPersistAlgorithm.LOG.isDebugEnabled())
        TopDownPersistAlgorithm.LOG.debug((object) new StringBuffer().append("createOid ").append((object) oid).ToString());
      return oid;
    }
    ...
    public virtual void makePersistent(NakedObject @object, PersistedObjectAdder manager)
    {
      ...
      {
        if (!TopDownPersistAlgorithm.LOG.isWarnEnabled())
          return;
        TopDownPersistAlgorithm.LOG.warn((object) new StringBuffer().append("can't make object persistent - either already persistent, or transient only: ").append((object) @object).ToString());
      }
      else
      {
        ...
        if (TopDownPersistAlgorithm.LOG.isInfoEnabled())
          TopDownPersistAlgorithm.LOG.info((object) new StringBuffer().append("persist ").append((object) @object).ToString());
    ...
    {
      if (TopDownPersistAlgorithm.LOG.isInfoEnabled())
        TopDownPersistAlgorithm.LOG.info((object) new StringBuffer().append("persist ").append((object) collection).ToString());
    ...
    static TopDownPersistAlgorithm()
    {
    ...
    {
      TopDownPersistAlgorithm persistAlgorithm = this;
