...
// Type: org.nakedobjects.viewer.cli.field.SelectReferenceToAddToFieldDispatcher
...
namespace org.nakedobjects.viewer.cli.field
{
  ...
  public class SelectReferenceToAddToFieldDispatcher : Dispatcher
  {
    public virtual void execute(Command command, Context context, View view)
    {
      AddToFieldAgent agent = (AddToFieldAgent) context.getAgent();
      ...
      agent.addReferenceToCollection(context, view, associate);
    }
    ...
    public virtual bool isAvailable(Context context) => context.currentAgentIs(Class.FromType(typeof (AddToFieldAgent)));

    [JavaThrownExceptions("1;java/lang/CloneNotSupportedException;")]
    [JavaFlags(4227077)]
    public new virtual object MemberwiseClone()
    {
      SelectReferenceToAddToFieldDispatcher toFieldDispatcher = this;
      ObjectImpl.clone((object) toFieldDispatcher);
      return ((object) toFieldDispatcher).MemberwiseClone();
    }
