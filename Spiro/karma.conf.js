...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'Spiro.Modern/Scripts/jquery-2.1.1.js',
      ...
      'Spiro.Modern/Scripts/spiro.modern.viewmodels.js',
      'Spiro.Modern/Scripts/spiro.modern.app.js',
      'Spiro.Modern/Scripts/spiro.modern.controllers.js',
      'Spiro.Modern/Scripts/spiro.modern.directives.js',
      'Spiro.Modern/Scripts/spiro.angular.services.representationloader.js',
      'Spiro.Modern/Scripts/spiro.modern.services.representationhandlers.js',
      'Spiro.Modern/Scripts/spiro.modern.services.viewmodelfactory.js',
      'Spiro.Modern/Scripts/spiro.modern.services.urlhelper.js',
      'Spiro.Modern/Scripts/spiro.modern.services.context.js',
      'Spiro.Modern/Scripts/spiro.modern.services.handlers.js',
      'Spiro.Modern/Scripts/spiro.angular.services.color.js',
      'Spiro.Modern/Scripts/spiro.angular.services.mask.js',
      'Spiro.Modern/Scripts/spiro.modern.services.navigation.simple.js',
      ...
      'Spiro.Modern/Tests/specs/maskService.js',
      'Spiro.Modern/Tests/specs/viewModelFactoryService.js'
    ],
