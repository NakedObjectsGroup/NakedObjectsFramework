...
namespace NakedObjects.Meta.Facet {
    ...
    public sealed class DeletingCallbackFacetViaMethod : DeletingCallbackFacetAbstract, IImperativeFacet {
        ...
        public override void Invoke(INakedObjectAdapter nakedObjectAdapter, ISession session, ILifecycleManager lifecycleManager, IMetamodelManager metamodelManager) => deletingDelegate(nakedObjectAdapter.GetDomainObject());
