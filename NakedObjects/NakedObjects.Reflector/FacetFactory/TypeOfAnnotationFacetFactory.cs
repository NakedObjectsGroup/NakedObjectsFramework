...
public sealed class TypeOfAnnotationFacetFactory : DomainObjectFacetFactoryProcessor {
    ...
    private static IImmutableDictionary<string, ITypeSpecBuilder> Process(IReflector reflector, Type methodReturnType, ISpecificationBuilder holder, IImmutableDictionary<string, ITypeSpecBuilder> metamodel) {
