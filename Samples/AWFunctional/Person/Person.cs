...
namespace AdventureWorksModel {
    ...
    public class Person : BusinessEntity {
        ...
        public IList<CreditCard> ListCreditCards(IQueryable<PersonCreditCard> pccs) {
            int id = this.BusinessEntityID;
            return pccs.Where(pcc => pcc.PersonID == id).Select(pcc => pcc.CreditCard).ToList();
        }

        public IQueryable<CreditCard> RecentCreditCards(IQueryable<PersonCreditCard> pccs)
        {
            int id = this.BusinessEntityID;
    ...
    public class EmailTemplate : IFunctionalViewModelEdit
    {
        #region IViewModelEdit
