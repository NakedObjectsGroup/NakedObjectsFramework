                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    function optionChanged() {
                        if (viewModel.isMultipleChoices) {
                            ...
                            var cvms = _.map(kvps, function (o) {
                                return Angular.ChoiceViewModel.create(new Spiro.Value(o.value), viewModel.id, o.key);
                            });
                            ...
                            var val = option.val();
                            var key = option.text();
                            var cvm = Angular.ChoiceViewModel.create(new Spiro.Value(val), viewModel.id, key);
