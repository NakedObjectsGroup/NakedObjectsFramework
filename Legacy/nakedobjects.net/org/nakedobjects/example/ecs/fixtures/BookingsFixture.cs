...
// Type: org.nakedobjects.example.ecs.fixtures.BookingsFixture
...
{
  public class BookingsFixture : JavaFixture
  {
    private readonly CitiesFixture cities;

    public BookingsFixture(CitiesFixture cities) => this.cities = cities;
    ...
    public override void install()
    {
      ...
      City boston = this.cities.boston;
      City newYork = this.cities.newYork;
      City washington = this.cities.washington;
      Location instance2 = (Location) this.createInstance(Class.FromType(typeof (Location)));
      instance2.setCity(boston);
