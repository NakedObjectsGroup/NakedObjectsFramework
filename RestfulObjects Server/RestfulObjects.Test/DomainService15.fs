...
let GetService(api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.ServiceId, TObjectVal(sName));
                         ...
                         TProperty(JsonPropertyNames.Members, TObjectJson([TProperty("AzContributedAction", TObjectJson(makeServiceActionMember "AzContributedAction" sName mst [ p1 ]));
                                                                           ...
                                                                           TProperty("AzContributedActionWithValueParm", TObjectJson(makeServiceActionMember "AzContributedActionWithValueParm" sName mst [p5; p6]));
...
let GetServiceFormalOnly(api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.ServiceId, TObjectVal(sName));
                         ...
                         TProperty(JsonPropertyNames.Members, TObjectJson([TProperty("AzContributedAction", TObjectJson(makeActionMemberFormal "services" "AzContributedAction" sName mst [p1]));
                                                                           ...
                                                                           TProperty("AzContributedActionWithRefParm", TObjectJson(makeActionMemberFormal "services" "AzContributedActionWithRefParm" sName mst [p3;p4]));
                                                                           TProperty("AzContributedActionWithValueParm", TObjectJson(makeActionMemberFormal "services" "AzContributedActionWithValueParm" sName mst [p5;p6]));
...
let GetServiceSimpleOnly(api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.ServiceId, TObjectVal(sName));
                         ...
                         TProperty(JsonPropertyNames.Members, TObjectJson([TProperty("AzContributedAction", TObjectJson(makeServiceActionMemberSimple "AzContributedAction" sName mst [p1]));
                                                                           ...
                                                                           TProperty("AzContributedActionWithRefParm", TObjectJson(makeServiceActionMemberSimple "AzContributedActionWithRefParm" sName mst [p3;p4]));
                                                                           TProperty("AzContributedActionWithValueParm", TObjectJson(makeServiceActionMemberSimple "AzContributedActionWithValueParm" sName mst [p5;p6]));
...
let GetWithActionService(api : RestfulObjectsControllerBase) =   
        ...
        let expected = [ TProperty(JsonPropertyNames.ServiceId, TObjectVal(oid));
                         ...
                         TProperty(JsonPropertyNames.Members, TObjectJson([TProperty("ADisabledAction", TObjectJson(TProperty(JsonPropertyNames.DisabledReason, TObjectVal("Always disabled")) ::makeServiceActionMemberNoParms "ADisabledAction"oid mst));
                                                                           ...
                                                                           TProperty("AnActionReturnsCollectionWithParameters", TObjectJson(makeServiceActionCollectionMember "AnActionReturnsCollectionWithParameters" oid mst [p25;p26]));
                                                                           TProperty("AnActionReturnsCollectionWithScalarParameters", TObjectJson(makeServiceActionCollectionMember "AnActionReturnsCollectionWithScalarParameters" oid mst [p27;p28])); 
                                                                           ...
                                                                           TProperty("AnActionReturnsObjectWithParameterAnnotatedQueryOnly", TObjectJson(makeServiceActionMember "AnActionReturnsObjectWithParameterAnnotatedQueryOnly" oid mst [p1]));                                                                           
                                                                           TProperty("AnActionReturnsObjectWithParameters", TObjectJson(makeServiceActionMember "AnActionReturnsObjectWithParameters" oid mst [p2;p3]));
                                                                           TProperty("AnActionReturnsObjectWithParametersAnnotatedIdempotent", TObjectJson(makeServiceActionMember "AnActionReturnsObjectWithParametersAnnotatedIdempotent" oid mst [p4;p5]));
                                                                           TProperty("AnActionReturnsObjectWithParametersAnnotatedQueryOnly", TObjectJson(makeServiceActionMember "AnActionReturnsObjectWithParametersAnnotatedQueryOnly" oid mst [p6;p7]));
                                                                           TProperty("AnActionReturnsQueryable", TObjectJson(makeServiceActionCollectionMemberNoParms "AnActionReturnsQueryable" oid mst));                          
                                                                           TProperty("AnActionReturnsQueryableWithParameters", TObjectJson(makeServiceActionCollectionMember "AnActionReturnsQueryableWithParameters" oid mst [p29;p30]));
                                                                           TProperty("AnActionReturnsQueryableWithScalarParameters", TObjectJson(makeServiceActionCollectionMember "AnActionReturnsQueryableWithScalarParameters"oid mst [p31;p32])); 
                                                                           TProperty("AnActionReturnsScalar", TObjectJson(makeActionMemberNumber "services" "AnActionReturnsScalar" oid "An Action Returns Scalar" "" "integer" []));
                                                                           TProperty("AnActionReturnsScalarEmpty", TObjectJson(makeActionMemberString  "services"  "AnActionReturnsScalarEmpty" oid "An Action Returns Scalar Empty" "" "string" []));
                                                                           TProperty("AnActionReturnsScalarNull", TObjectJson(makeActionMemberString "services" "AnActionReturnsScalarNull" oid "An Action Returns Scalar Null" "" "string" []));
                                                                           TProperty("AnActionReturnsScalarWithParameters", TObjectJson(makeActionMemberNumber "services" "AnActionReturnsScalarWithParameters" oid "An Action Returns Scalar With Parameters" "" "integer" [p33;p34]));
                                                                           TProperty("AnActionReturnsVoid", TObjectJson(makeServiceActionVoidMember "AnActionReturnsVoid" oid));
                                                                           TProperty("AnActionReturnsVoidWithParameters", TObjectJson(makeVoidActionMember "services" "AnActionReturnsVoidWithParameters" oid "An Action Returns Void With Parameters" "an action for testing" [p35;p36] ));                                                                           
                                                                           TProperty("AnActionValidateParameters", TObjectJson(makeActionMemberNumber "services" "AnActionValidateParameters" oid "An Action Validate Parameters" "" "integer" [p37;p38]));
                                                                           TProperty("AnActionWithCollectionParameter", TObjectJson(makeVoidActionMember "services" "AnActionWithCollectionParameter" oid "An Action With Collection Parameter" "" [p43]));
                                                                           TProperty("AnActionWithCollectionParameterRef", TObjectJson(makeVoidActionMember "services" "AnActionWithCollectionParameterRef" oid "An Action With Collection Parameter Ref" "" [p44]));                                                                           
                                                                           TProperty("AnActionWithDateTimeParm", TObjectJson(makeVoidActionMember "services" "AnActionWithDateTimeParm" oid "An Action With Date Time Parm" "" [p39]));
                                                                           TProperty("AnActionWithOptionalParm", TObjectJson(makeServiceActionMember "AnActionWithOptionalParm" oid mst [p8]));
                                                                           TProperty("AnActionWithOptionalParmQueryOnly", TObjectJson(makeServiceActionMember "AnActionWithOptionalParmQueryOnly" oid mst [p9]));
                                                                           TProperty("AnActionWithParametersWithChoicesWithDefaults", TObjectJson(makeServiceActionMember "AnActionWithParametersWithChoicesWithDefaults"oid mst [p10;p11;p12;p13]));
                                                                           TProperty("AnActionWithReferenceParameter", TObjectJson(makeServiceActionMember "AnActionWithReferenceParameter"oid mst [p14]));
                                                                           TProperty("AnActionWithReferenceParameterWithChoices", TObjectJson(makeServiceActionMember "AnActionWithReferenceParameterWithChoices"oid mst [p15]));
                                                                           TProperty("AnActionWithReferenceParameterWithConditionalChoices", TObjectJson(makeServiceActionMember "AnActionWithReferenceParameterWithConditionalChoices"oid mst [p40]));
                                                                           TProperty("AnActionWithReferenceParameterWithDefault", TObjectJson(makeServiceActionMember "AnActionWithReferenceParameterWithDefault"oid mst [p16]));
                                                                           TProperty("AnActionWithReferenceParametersWithAutoComplete", TObjectJson(makeServiceActionMember "AnActionWithReferenceParametersWithAutoComplete"oid mst [p17;p18]));
                                                                           TProperty("AnOverloadedAction0", TObjectJson(makeActionMember "services" "AnOverloadedAction0" oid "An Overloaded Action" "" mst []));                                                                                                                                                    
                                                                           TProperty("AnOverloadedAction1", TObjectJson(makeActionMember "services" "AnOverloadedAction1" oid "An Overloaded Action" "" mst [p19]));
                                                                           TProperty("AnActionWithValueParameter", TObjectJson(makeServiceActionMember "AnActionWithValueParameter"oid mst [p20]));
                                                                           TProperty("AnActionWithValueParametersWithConditionalChoices", TObjectJson(makeServiceActionMember "AnActionWithValueParametersWithConditionalChoices"oid mst [p41;p42]));
                                                                           TProperty("AnActionWithValueParameterWithChoices", TObjectJson(makeServiceActionMember "AnActionWithValueParameterWithChoices"oid mst [p21]));
                                                                           TProperty("AnActionWithValueParameterWithDefault", TObjectJson(makeServiceActionMember "AnActionWithValueParameterWithDefault"oid mst [p22]));
                                                                           TProperty("AnError", TObjectJson(makeActionMemberNumber "services" "AnError"oid  "An Error" "" "integer" []));
