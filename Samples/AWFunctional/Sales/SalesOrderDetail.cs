...
namespace AdventureWorksModel {
    ...
    public class SalesOrderDetail {
        ...
        public void ChangeQuantity(short newQuantity, IFunctionalContainer container) {
            OrderQty = newQuantity;
            SpecialOfferProduct = SpecialOfferProduct.Product.BestSpecialOfferProduct(newQuantity, container);
            Recalculate();
        }
