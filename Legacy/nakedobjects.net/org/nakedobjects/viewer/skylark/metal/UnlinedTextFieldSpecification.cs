...
// Type: org.nakedobjects.viewer.skylark.metal.UnlinedTextFieldSpecification
...
{
  public class UnlinedTextFieldSpecification : AbstractFieldSpecification
  {
    public override bool canDisplay(Content content) => content.isValue() && !(content.getNaked() is MultilineStringValue);

    public override View createView(Content content, ViewAxis axis) => (View) new SingleLineTextField(content, (ViewSpecification) this, axis, false, 30);
