...
namespace AdventureWorksModel {
    ...
    public class Product {
        ...
        public virtual IQueryable<ProductModel> AutoCompleteProductModel(string match, IQueryable<ProductModel> pms) {
            return pms.Where(pm => pm.Name.ToUpper().Contains(match.ToUpper()));
        }
        ...
        public IList<ProductSubcategory> ChoicesProductSubcategory(ProductCategory productCategory, IQueryable<ProductSubcategory> subs) {
            if (productCategory != null) {
                return (from psc in subs
        ...
        public virtual SpecialOffer BestSpecialOffer(short quantity, IFunctionalContainer container) {
            return BestSpecialOfferProduct(quantity, container).SpecialOffer;
        }
        ...
        [NakedObjectsIgnore]
        public virtual SpecialOfferProduct BestSpecialOfferProduct(
            short quantity, 
            ...
            SpecialOffer none = SpecialOfferRepository.NoDiscount(container);
            return SpecialOfferRepository.AssociateSpecialOfferWithProduct(none, this, container);
        }
