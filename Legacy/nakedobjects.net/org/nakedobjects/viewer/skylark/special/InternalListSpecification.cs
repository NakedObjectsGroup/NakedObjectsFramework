...
// Type: org.nakedobjects.viewer.skylark.special.InternalListSpecification
...
namespace org.nakedobjects.viewer.skylark.special
{
  ...
  public class InternalListSpecification : AbstractCompositeViewSpecification, SubviewSpec
  {
    public InternalListSpecification() => this.builder = (CompositeViewBuilder) new InternalListDecorator((CompositeViewBuilder) new StackLayout((CompositeViewBuilder) new CollectionElementBuilder((SubviewSpec) this, true)));
