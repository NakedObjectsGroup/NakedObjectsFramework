...
type Nof4Tests() = class      
    ...
    override x.RegisterTypes(container) = 
        ...
        let ignore = container.RegisterType(typeof<IOidStrategy>, typeof<ExternalOid>, null, (new PerResolveLifetimeManager()))
        let ignore = container.RegisterType(typeof<INakedObjectsSurface>, typeof<NakedObjectsSurface>, null, (new PerResolveLifetimeManager()))
        ()         
