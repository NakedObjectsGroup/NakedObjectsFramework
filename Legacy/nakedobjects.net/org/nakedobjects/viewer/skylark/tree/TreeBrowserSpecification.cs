...
// Type: org.nakedobjects.viewer.skylark.tree.TreeBrowserSpecification
...
namespace org.nakedobjects.viewer.skylark.tree
{
  ...
  public class TreeBrowserSpecification : ViewSpecification
  {
    ...
    {
      ClosedObjectNodeSpecification nodeSpecification1 = new ClosedObjectNodeSpecification(false);
      NodeSpecification collectionLeafNodeSpecification = (NodeSpecification) new ClosedCollectionNodeSpecification();
      EmptyNodeSpecification nodeSpecification2 = new EmptyNodeSpecification();
      ...
      this.openCollection.setReplacementNodeSpecification((ViewSpecification) collectionLeafNodeSpecification);
      this.openObject = new OpenObjectNodeSpecification();
      this.openObject.setCollectionSubNodeSpecification(collectionLeafNodeSpecification);
      this.openObject.setObjectSubNodeSpecification((NodeSpecification) nodeSpecification2);
      ...
      collectionLeafNodeSpecification.setReplacementNodeSpecification((ViewSpecification) this.openCollection);
    }

    [JavaFlags(4)]
    public virtual View addBorder(View frame) => (View) new WindowBorder(frame);
    ...
    public virtual View createView(Content content, ViewAxis axis)
    {
      ...
      view1.setFocusManager((FocusManager) new NullFocusManager());
      return view1;
    }

    public virtual string getName() => "Short Tree Browser";
    ...
    {
      TreeBrowserSpecification browserSpecification = this;
