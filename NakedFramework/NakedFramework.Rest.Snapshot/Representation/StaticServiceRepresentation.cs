...
[DataContract]
public class StaticServiceRepresentation : Representation {
    protected StaticServiceRepresentation(IFrameworkFacade frameworkFacade, HttpRequest req, IMenuFacade menu, RestControlFlags flags)
        : base(frameworkFacade.OidStrategy, flags) {
        var helper = new UriMtHelper(frameworkFacade.OidStrategy, req, menu);
        SetScalars(menu);
        SelfRelType = new ServiceRelType(RelValues.Self, helper);
    ...
    [DataMember(Name = JsonPropertyNames.ServiceId)]
    ...
    public static StaticServiceRepresentation Create(IFrameworkFacade frameworkFacade, IMenuFacade menu, HttpRequest req, RestControlFlags flags) => new(frameworkFacade, req, menu, flags);
