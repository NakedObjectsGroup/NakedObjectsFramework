...
namespace AdventureWorksModel {
    ...
    public class PurchaseOrderHeader  {
        ...
        public ShipMethod DefaultShipMethod(IQueryable<ShipMethod> shipMethods)
        {
        ...
        public QueryResultSingle DefaultOrderPlacedBy(IFunctionalContainer container) {
            return EmployeeRepository.RandomEmployee(container);
        }
        ...
        [PageSize(10)]
        public IQueryable<Product> AutoComplete0AddNewDetails([MinLength(3)] string matching, IFunctionalContainer container)
        {
            return ProductRepository.QueryProductByName(matching, container);
        }
