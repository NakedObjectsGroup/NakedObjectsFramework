...
[TestClass]
public class HideInClientAnnotationFacetFactoryTest : AbstractFacetFactoryTest {
...
// ReSharper disable UnusedParameter.Local
        public void SomeAction([HideInClient] string foo) { }
    }
    ...
    private class Customer4 {
        public void SomeAction([HideInClient] int foo) { }
    }
    ...
    public void TestPresentationHintAnnotationPickedUpOnAction() {
        ...
        Assert.AreEqual("hide-in-client", hintFacet.Value);
        Assert.IsNotNull(metamodel);
    }
