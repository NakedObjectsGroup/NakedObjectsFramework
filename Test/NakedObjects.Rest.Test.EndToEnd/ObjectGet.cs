...
public class ObjectGet : ObjectAbstract {
    ...
    protected override string FilePrefix => "Object-Get-";
    ...
    public void AttemptWithMalformedDomainModel() {
        var url = Urls.Objects + Urls.MostSimple1 + JsonRep.DomainModeQueryStringMalformed;
    ...
    public void AttemptGetWithMalformedQueryString() {
        ...
        const string url = $"{Urls.MostSimple1}?x-ro-validate-only=malformed";
