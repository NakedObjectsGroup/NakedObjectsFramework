...
namespace NakedFunctions.Reflector.FacetFactory {
    public sealed class MemberOrderAnnotationFacetFactory : FunctionalFacetFactoryProcessor, IAnnotationBasedFacetFactory {
        ...
        private static IMemberOrderFacet Create(MemberOrderAttribute attribute, ISpecification holder) => attribute is null ? null : new MemberOrderFacet("", attribute.Order.ToString(), holder) {Grouping = attribute.Grouping};
    }
}