                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "Id") 
                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "AChoicesValue") 
                                                                                           RepresentationTypes.PropertyDescription "") ]))
                                                                      TProperty(JsonPropertyNames.Extensions, 
                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "AConditionalChoicesValue") 
                                                                                           RepresentationTypes.PropertyDescription "") ]))
                                                                      TProperty(JsonPropertyNames.Extensions, 
                                                                                TObjectJson([ TProperty(JsonPropertyNames.FriendlyName, TObjectVal("A Conditional Choices Value"))
                                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""))
                                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal("number"))
                                                                                              TProperty(JsonPropertyNames.Format, TObjectVal("integer"))
                                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0))
                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "ADateTimeValue") 
                                                                                           RepresentationTypes.PropertyDescription "") ]))
                                                                      TProperty(JsonPropertyNames.Extensions, 
                                                                                TObjectJson([ TProperty(JsonPropertyNames.Description, TObjectVal("A datetime value for testing"))
                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "ADisabledValue") 
                                                                                           RepresentationTypes.PropertyDescription "") ]))
                                                                      TProperty(JsonPropertyNames.Extensions, 
                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "AStringValue") 
                                                                                           RepresentationTypes.PropertyDescription "") ]))
                                                                      TProperty(JsonPropertyNames.Extensions, 
                                                                                TObjectJson([ TProperty(JsonPropertyNames.Description, TObjectVal("A string value for testing"))
                                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal("string"))
                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "AUserDisabledValue") 
                                                                                           RepresentationTypes.PropertyDescription "") ]))
                                                                      TProperty(JsonPropertyNames.Extensions, 
                                                        ...
                                                        TObjectJson([ TProperty(JsonPropertyNames.MemberType, TObjectVal(MemberTypes.Property))
                                                                      ...
                                                                      TProperty
                                                                          (JsonPropertyNames.Links, 
                                                                           ...
                                                                           TArray
                                                                               ([ TObjectJson
                                                                                      (makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s/properties/%s" roType "AValue") 
                                                                                           RepresentationTypes.PropertyDescription "") ]))
                                                                      TProperty(JsonPropertyNames.Extensions, 
...
let GetWithReferenceTransientObject(api : RestfulObjectsControllerBase) = 
    ...
    let argsMembers = 
        TProperty(JsonPropertyNames.Members, 
                  TObjectJson([ TProperty("AChoicesReference", TObjectJson([ TProperty(JsonPropertyNames.Value, TObjectJson([ TProperty(JsonPropertyNames.Href, TObjectVal(new hrefType(oid))) ])) ]))
                                
                                TProperty
                                    ("AConditionalChoicesReference", 
                                     TObjectJson([ TProperty(JsonPropertyNames.Value, TObjectJson([ TProperty(JsonPropertyNames.Href, TObjectVal(new hrefType(oid))) ])) ]))
                                ...
                                TProperty
                                    ("AnAutoCompleteReference", TObjectJson([ TProperty(JsonPropertyNames.Value, TObjectJson([ TProperty(JsonPropertyNames.Href, TObjectVal(new hrefType(oid))) ])) ]))
        ...
        TObjectJson([ TProperty(JsonPropertyNames.Title, TObjectVal("0"))
                      TProperty(JsonPropertyNames.Links, 
                                TArray([ TObjectJson(makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s" roType) RepresentationTypes.DomainType "")
                                         ...
                                         TObjectJson(args :: makePostLinkProp RelValues.Persist (sprintf "objects/%s" roType) RepresentationTypes.Object "") ]))
                      TProperty(JsonPropertyNames.Members, 
                                TObjectJson([ TProperty("AChoicesReference", TObjectJson(makePropertyMemberShortNoDetails "objects" "AChoicesReference" roType "A Choices Reference" "" mst false val1))
                                              
                                              TProperty
                                                  ("AConditionalChoicesReference", 
                                                   TObjectJson(makePropertyMemberShortNoDetails "objects" "AConditionalChoicesReference" roType "A Conditional Choices Reference" "" mst false val6))
                                              ...
                                              TProperty
                                                  ("ADisabledReference", 
                                                   ...
                                                   TObjectJson
                                                       (TProperty(JsonPropertyNames.DisabledReason, TObjectVal("Field not editable")) 
                                                        :: (makePropertyMemberShortNoDetails "objects" "ADisabledReference" roType "A Disabled Reference" "" mst false val2)))
                                              
                                              TProperty
                                                  ("ANullReference", TObjectJson(makePropertyMemberShortNoDetails "objects" "ANullReference" roType "A Null Reference" "" mst true (TObjectVal(null))))
                                              ...
                                              TProperty
                                                  ("AnAutoCompleteReference", 
                                                   TObjectJson(makePropertyMemberShortNoDetails "objects" "AnAutoCompleteReference" roType "An Auto Complete Reference" "" mst false val5))
        ...
        TObjectJson([ TProperty(JsonPropertyNames.Title, TObjectVal("0"))
                      TProperty(JsonPropertyNames.Links, 
                                TArray([ TObjectJson(makeGetLinkProp RelValues.DescribedBy (sprintf "domain-types/%s" roType) RepresentationTypes.DomainType "")
                                         ...
                                         TObjectJson(args :: makePostLinkProp RelValues.Persist (sprintf "objects/%s" roType) RepresentationTypes.Object "") ]))
                      TProperty(JsonPropertyNames.Members, 
                                TObjectJson([ TProperty("ACollection", TObjectJson(makeCollectionMemberNoValue "ACollection" roid "A Collection" "" "list" 2 mst "Most Simples"))
                                              
                                              TProperty
                                                  ("ACollectionViewModels", 
                                                   TObjectJson(makeCollectionMemberNoValue "ACollectionViewModels" roid "A Collection View Models" "" "list" 2 mstv "Most Simple View Models"))
                                              
                                              TProperty
                                                  ("ADisabledCollection", TObjectJson((makeCollectionMemberNoValue "ADisabledCollection" roid "A Disabled Collection" "" "list" 2 mst "Most Simples")))
                                              
                                              TProperty
                                                  ("AnEmptyCollection", 
                                                   TObjectJson(makeCollectionMemberNoValue "AnEmptyCollection" roid "An Empty Collection" "an empty collection for testing" "list" 0 mst "Most Simples"))
        ...
        [ TProperty(JsonPropertyNames.DomainType, TObjectVal(oType))
          ...
          TProperty(JsonPropertyNames.Members, 
                    TObjectJson([ TProperty("AChoicesValue", TObjectJson(makeObjectPropertyMember "AChoicesValue" oid "A Choices Value" (TObjectVal(3))))
                                  ...
                                  TProperty
                                      ("AStringValue", 
                                       TObjectJson(makePropertyMemberString "objects" "AStringValue" oid "A String Value" "A string value for testing" true (TObjectVal("one hundred four")) []))
        ...
        [ //TProperty(JsonPropertyNames.DomainType, TObjectVal(oType));
          ...
          TProperty(JsonPropertyNames.Members, 
                    TObjectJson([ TProperty("AChoicesValue", TObjectJson(makePropertyMemberFormal "objects" "AChoicesValue" oid (TObjectVal(3)) false))
                                  ...
                                  TProperty
                                      ("ADateTimeValue", 
                                       TObjectJson(makePropertyMemberFormal "objects" "ADateTimeValue" oid (TObjectVal(DateTime.Parse("2012-02-10T00:00:00Z").ToUniversalTime())) true))
                                  TProperty("ADisabledValue", TObjectJson(disabledValue))
        ...
        [ TProperty(JsonPropertyNames.DomainType, TObjectVal(oType))
          ...
          TProperty(JsonPropertyNames.Links, 
                    TArray([ TObjectJson(makeGetLinkProp RelValues.Self (sprintf "objects/%s" oid) RepresentationTypes.Object oType)
                             ...
                             TObjectJson(arguments :: makePutLinkProp RelValues.Update (sprintf "objects/%s" oid) RepresentationTypes.Object oType) ]))
          TProperty(JsonPropertyNames.Members, 
                    TObjectJson([ TProperty("AChoicesReference", TObjectJson(makePropertyMemberShort "objects" "AChoicesReference" oid "A Choices Reference" "" roType false val1 []))
                                  
                                  TProperty
                                      ("AConditionalChoicesReference", 
                                       TObjectJson(makePropertyMemberShort "objects" "AConditionalChoicesReference" oid "A Conditional Choices Reference" "" roType false val6 []))
        ...
        [ TProperty(JsonPropertyNames.DomainType, TObjectVal(oType))
          ...
          TProperty(JsonPropertyNames.Links, 
                    TArray([ TObjectJson(makeGetLinkProp RelValues.Self (sprintf "objects/%s" oid) RepresentationTypes.Object oType)
                             ...
                             TObjectJson(arguments :: makePutLinkProp RelValues.Update (sprintf "objects/%s" oid) RepresentationTypes.Object oType) ]))
          TProperty(JsonPropertyNames.Members, 
                    TObjectJson([ TProperty("ACollection", TObjectJson(makeCollectionMember "ACollection" oid "A Collection" "" ResultTypes.List 2))
                                  
                                  TProperty
                                      ("ACollectionViewModels", 
                                       
                                       TObjectJson
                                           (makeCollectionMemberType "ACollectionViewModels" oid "A Collection View Models" "" ResultTypes.List 2 (ttc "RestfulObjects.Test.Data.MostSimpleViewModel") 
