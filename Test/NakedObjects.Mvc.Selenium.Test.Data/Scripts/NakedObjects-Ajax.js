var nakedObjects = (function () {
    ...
    function replaceFormValues() {
        $("form.nof-edit, form.nof-dialog, form.nof-dialog-file").each(function() {
...
$(function () { $(document).on("submit", "form:has(button.nof-summary)", nakedObjects.redisplayProperty); });
$(function () { $(document).on("submit", "form:has(button.nof-maximize)", nakedObjects.redisplayInlineProperty); });
$(function () { $(document).on("submit", "form.nof-edit", nakedObjects.redisplayProperty); });
...
$(function () { $(document).on("change", '#checkboxAll', function() {
     $("input[type='checkbox']").prop('checked', $('#checkboxAll').is(':checked'));
