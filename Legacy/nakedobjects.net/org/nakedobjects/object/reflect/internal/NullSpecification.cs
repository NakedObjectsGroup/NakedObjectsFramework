...
// Type: org.nakedobjects.object.reflect.internal.NullSpecification
...
namespace org.nakedobjects.@object.reflect.@internal
{
  ...
  public class NullSpecification : NakedObjectSpecification
  {
    private readonly string name;

    public NullSpecification(string name) => this.name = name;
    ...
    public virtual NakedObjectField[] getAccessibleFieldsForCollectiveView()
    {
      int length = 0;
      return length >= 0 ? new NakedObjectField[length] : throw new NegativeArraySizeException();
    }
    ...
    {
      NullSpecification nullSpecification = this;
      ObjectImpl.clone((object) nullSpecification);
      return ((object) nullSpecification).MemberwiseClone();
    }
  }
}
