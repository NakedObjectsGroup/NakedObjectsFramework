...
namespace AdventureWorksModel {
    ...
    public class SalesPerson : IBusinessEntity {
        ...
        [MemberOrder(1)]
        public void RecalulateSalesYTD(IQueryable<SalesOrderHeader> headers) {
            var startOfYear = new DateTime(DateTime.Now.Year, 1, 1);
            IQueryable<SalesOrderHeader> query = from obj in headers
        ...
        public void ChangeSalesTerritory(SalesTerritory newTerritory) {
            ...
            var history = new SalesTerritoryHistory();
            history.SalesPerson = this;
