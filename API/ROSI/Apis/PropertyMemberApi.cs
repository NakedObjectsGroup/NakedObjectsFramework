...
public static class PropertyMemberApi {
    public static async Task<PropertyDetails> GetDetails(this PropertyMember propertyRepresentation, IInvokeOptions? options = null) {
    ...
    public static async Task<bool> GetHasChoices(this PropertyMember propertyRepresentation, IInvokeOptions? options = null) {
    ...
    public static async Task<IEnumerable<T?>> GetChoices<T>(this PropertyMember propertyRepresentation, IInvokeOptions? options = null) {
        if (propertyRepresentation.HasChoicesFlag()) {
    ...
    public static async Task<IEnumerable<Link>> GetLinkChoices(this PropertyMember propertyRepresentation, IInvokeOptions? options = null) {
        if (propertyRepresentation.HasChoicesFlag()) {
    ...
    public static async Task<IEnumerable<T?>> GetPrompts<T>(this PropertyMember propertyRepresentation, IInvokeOptions options, params object[] pp) {
    ...
    public static async Task<IEnumerable<Link>> GetLinkPrompts(this PropertyMember propertyRepresentation, IInvokeOptions options, params object[] pp) {
        if (propertyRepresentation.HasPromptLink()) {
            var prompt = await ApiHelpers.GetPrompt(propertyRepresentation, options, pp);
