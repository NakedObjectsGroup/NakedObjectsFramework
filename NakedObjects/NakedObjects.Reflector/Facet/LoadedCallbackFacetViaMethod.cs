...
public sealed class LoadedCallbackFacetViaMethod : LoadedCallbackFacetAbstract, IImperativeFacet {
    ...
    public LoadedCallbackFacetViaMethod(MethodInfo method, ILogger<LoadedCallbackFacetViaMethod> logger) => methodWrapper = SerializationFactory.Wrap(method, logger);
