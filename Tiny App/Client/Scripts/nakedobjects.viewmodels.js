...
(function (NakedObjects) {
    ...
    var ListViewModel = (function (_super) {
        ...
        function ListViewModel(colorService, contextService, viewModelFactory, urlManager, focusManager, $q) {
            ...
            this.recreate = function (page, pageSize) {
                return _this.routeData.objectId ?
                    _this.contextService.getListFromObject(_this.routeData.paneId, _this.routeData.objectId, _this.routeData.actionId, _this.routeData.actionParams, page, pageSize) :
                    _this.contextService.getListFromMenu(_this.routeData.paneId, _this.routeData.menuId, _this.routeData.actionId, _this.routeData.actionParams, page, pageSize);
            };
        ...
        ListViewModel.prototype.reset = function (list, routeData) {
            ...
            this.items = this.viewModelFactory.getItems(links, this.state === NakedObjects.CollectionViewState.Table, routeData, this);
            ...
            this.size = count;
            this.description = function () { return ("Page " + _this.page + " of " + _this.numPages + "; viewing " + count + " of " + totalCount + " items"); };
        ...
        ListViewModel.prototype.description = function () { return this.size.toString(); };
