...
namespace AdventureWorksModel {
    ...
    public class SalesOrderHeader : ICreditCardCreator {
        ...
        //    IQueryable<StoreContact> query = from obj in allStoreContact>()
        ...
        [Executed(Where.Remotely)]
        public List<Address> ChoicesShippingAddress(IFunctionalContainer container) {
            return ChoicesBillingAddress(container);
        }
        #endregion
        ...
        public ShipMethod DefaultShipMethod(IQueryable<ShipMethod> methods) {
        ...
        public IQueryable<SalesPerson> AutoCompleteSalesPerson(
            ...
            return SalesRepository.FindSalesPersonByName(null, name, container);
        }
...
#pragma warning restore 612,618
        public SalesOrderDetail AddNewDetail(
            ...
            sod.SpecialOfferProduct = product.BestSpecialOfferProduct(quantity, container);
            sod.Recalculate();
        ...
        [PageSize(20)]
        public IQueryable<Product> AutoComplete0AddNewDetail([MinLength(2)] string name, IFunctionalContainer container) {
            return ProductRepository.QueryProductByName(name, container);
        }
        #endregion
...
#pragma warning restore 612,618
        ...
        [PageSize(20)]
        public IQueryable<Product> AutoComplete0AddNewDetails([MinLength(2)] string name, IFunctionalContainer container)
        {
            return AutoComplete0AddNewDetail(name, container);
        }
