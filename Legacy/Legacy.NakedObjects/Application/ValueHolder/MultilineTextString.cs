...
namespace Legacy.NakedObjects.Application.ValueHolder {
    public class MultilineTextString : TextString {
        ...
        public override void setValue(string text) => base.setValue(convertLineEnding(text));

        public override void restoreFromEncodedString(string data) => base.restoreFromEncodedString(convertLineEnding(data));
