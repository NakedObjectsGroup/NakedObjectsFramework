...
namespace NakedObjects.Meta.Facet {
    ...
    public sealed class DeletedCallbackFacetViaMethod : DeletedCallbackFacetAbstract, IImperativeFacet {
        ...
        public override void Invoke(INakedObjectAdapter nakedObjectAdapter, ISession session, ILifecycleManager lifecycleManager, IMetamodelManager metamodelManager) => deletedDelegate(nakedObjectAdapter.GetDomainObject());
