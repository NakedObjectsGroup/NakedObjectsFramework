...
public static class ArgumentApi {
    public static object? GetValue(this Argument argumentRepresentation) =>
        argumentRepresentation.GetMandatoryProperty(JsonConstants.Value) is JValue v ? v.Value : null;

    public static Link? GetLinkValue(this Argument argumentRepresentation) =>
        argumentRepresentation.GetMandatoryProperty(JsonConstants.Value) is JObject jo ? new Link(jo) : null;
