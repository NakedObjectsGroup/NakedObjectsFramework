...
(function (NakedObjects) {
    ...
    var Command = (function () {
        ...
        Command.prototype.getObject = function () {
            var _this = this;
            var oid = this.routeData().objectId;
            //TODO: Consider view model & transient modes?
            return this.context.getObjectByOid(1, oid, this.routeData().interactionMode).then(function (obj) {
        ...
        Goto.prototype.doExecute = function (args, chained) {
            ...
            if (this.isList()) {
                ...
                this.getList().then(function (list) {
                    if (itemNo_1 < 1 || itemNo_1 > list.value().length) {
                        _this.clearInputAndSetMessage(arg0 + " is out of range for displayed items");
                        return;
                    }
                    var link = list.value()[itemNo_1 - 1]; // On UI, first item is '1'
    ...
    var Help = (function (_super) {
        ...
        function Help() {
            ...
            this.helpText = "If no argument is specified, help lists the commands available\n" +
    ...
    var Show = (function (_super) {
        ...
        Show.prototype.renderCollectionItems = function (coll, startNo, endNo) {
            ...
            if (coll.value()) {
                ...
                this.context.getCollectionDetails(coll).then(function (details) {
