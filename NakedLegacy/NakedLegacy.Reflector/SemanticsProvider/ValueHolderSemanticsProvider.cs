...
[Serializable]
public sealed class ValueHolderSemanticsProvider : ValueSemanticsProviderAbstract<WholeNumber>, IIntegerValueFacet {
    private const bool Immutable = true;
    private const int TypicalLengthConst = 11;
    private static WholeNumber DefaultValueConst = new(0);

    public ValueHolderSemanticsProvider(IObjectSpecImmutable spec, ISpecification holder)
