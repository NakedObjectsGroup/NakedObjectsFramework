...
let VerifyActionProperty refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         ...
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action"));
                         ...
                         TProperty(JsonPropertyNames.Links, TArray( [ TObjectJson(makeGetLinkProp RelValues.Self purl RepresentationTypes.ObjectAction ""); 
                                                                      TObjectJson(makeGetLinkProp RelValues.Up ourl  RepresentationTypes.Object oType); 
                                                                      TObjectJson(TProperty(JsonPropertyNames.Arguments, TObjectJson([])) :: makePostLinkProp invokeRelType (purl + "/invoke")  RepresentationTypes.ActionResult "" );
...
let VerifyActionPropertyWithDateTime refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let parm1 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         ...
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Date Time Parm"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
...
let VerifyActionPropertyWithCollection refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let parm1 = TObjectJson( [ TProperty(JsonPropertyNames.Choices,  TArray( [TObjectVal("string1");TObjectVal("string2");TObjectVal("string3")]));
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([TProperty(pmid, parm1)]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Collection Parameter"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
                         TProperty(JsonPropertyNames.Links, TArray( [ TObjectJson(makeGetLinkProp RelValues.Self purl RepresentationTypes.ObjectAction ""); 
...
let VerifyOverloadedActionProperty refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Overloaded Action"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(false))]) );
...
let VerifyContributedServiceAction refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("A Non Contributed Action"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(false))]) );
...
let VerifyActionPropertyQueryOnly refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action Annotated Query Only"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(false))]) );
                         TProperty(JsonPropertyNames.Links, TArray( [ TObjectJson(makeGetLinkProp RelValues.Self purl RepresentationTypes.ObjectAction ""); 
                                                                      TObjectJson(makeGetLinkProp RelValues.Up ourl  RepresentationTypes.Object oType); 
                                                                      TObjectJson(TProperty(JsonPropertyNames.Arguments, TObjectJson([])) :: makeGetLinkProp invokeRelType (purl + "/invoke")  RepresentationTypes.ActionResult "");
                                                                      TObjectJson(makeGetLinkProp RelValues.ReturnType rturl RepresentationTypes.DomainType ""); 
                                                                      TObjectJson(makeGetLinkProp RelValues.DescribedBy dburl RepresentationTypes.ActionDescription "")]))]
...
let VerifyActionPropertyIdempotent refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action Annotated Idempotent"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(false))]) );
                         TProperty(JsonPropertyNames.Links, TArray( [ TObjectJson(makeGetLinkProp RelValues.Self purl RepresentationTypes.ObjectAction ""); 
                                                                      TObjectJson(makeGetLinkProp RelValues.Up ourl  RepresentationTypes.Object oType); 
                                                                      TObjectJson(TProperty(JsonPropertyNames.Arguments, TObjectJson([])) :: makePutLinkProp invokeRelType (purl + "/invoke")  RepresentationTypes.ActionResult "" );
                                                                      TObjectJson(makeGetLinkProp RelValues.ReturnType rturl RepresentationTypes.DomainType ""); 
                                                                      TObjectJson(makeGetLinkProp RelValues.DescribedBy dburl RepresentationTypes.ActionDescription "") ]))]
...
let VerifyActionPropertyWithOptParm refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let parm1 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Optional Parm"));
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([TProperty(pmid, parm1)]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Optional Parm"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyActionPropertyWithOptParmSimpleOnly refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let parm1 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( []));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Optional Parm"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal("an optional parm"));
                                                                                        TProperty(JsonPropertyNames.ReturnType, TObjectVal("string"));
                                                                                        TProperty(JsonPropertyNames.Format, TObjectVal("string"));
...
let VerifyScalarAction refType oType oid f (api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action Returns Scalar"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
...
let VerifyQueryAction refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action Returns Queryable"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
...
let VerifyCollectionAction refType oType oid f (api : RestfulObjectsControllerBase)=    
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action Returns Collection"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ResultTypes.List));
                                                                              TProperty(JsonPropertyNames.ElementType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.PluralName, TObjectVal("Most Simples"));
...
let VerifyQueryActionWithParms refType oType oid f (api : RestfulObjectsControllerBase)=    
        ...
        let parm1 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl1 RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm1"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                        TProperty(JsonPropertyNames.ReturnType, TObjectVal("number"));     
                                                                                        TProperty(JsonPropertyNames.Format, TObjectVal("integer"));                                                                  
                                                                                        TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])

        let parm2 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl2 RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm2"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                        TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));                                                                       
                                                                                        TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])

        let args =  TObjectJson([TProperty(pmid1, TObjectJson([TProperty(JsonPropertyNames.Value, TObjectVal(null))]));
                                 TProperty(pmid2, TObjectJson([TProperty(JsonPropertyNames.Value, TObjectVal(null))]))])

        let invokeRelType = RelValues.Invoke + makeParm RelParamValues.Action pid

        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([TProperty(pmid1, parm1); TProperty(pmid2, parm2) ]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action Returns Queryable With Parameters"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ResultTypes.List));
                                                                              TProperty(JsonPropertyNames.ElementType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.PluralName, TObjectVal("Most Simples"));
                         ...
                         TProperty(JsonPropertyNames.Links, TArray( [ TObjectJson(makeGetLinkProp RelValues.Self purl RepresentationTypes.ObjectAction ""); 
                                                                      TObjectJson(makeGetLinkProp RelValues.Up ourl  RepresentationTypes.Object oType); 
                                                                      TObjectJson(TProperty(JsonPropertyNames.Arguments, args) :: makeGetLinkProp invokeRelType (purl + "/invoke") RepresentationTypes.ActionResult "");                                                      
                                                                      TObjectJson(makeGetLinkProp RelValues.ReturnType rturl RepresentationTypes.DomainType ""); 
                                                                      TObjectJson(makeGetLinkProp RelValues.ElementType eturl RepresentationTypes.DomainType "");
                                                                      TObjectJson(makeGetLinkProp RelValues.DescribedBy dburl RepresentationTypes.ActionDescription "");
                                                                      TObjectJson(TProperty(JsonPropertyNames.Id, TObjectVal(pmid1)) :: makeGetLinkProp RelValues.ActionParam pmurl1 RepresentationTypes.ActionParamDescription "");
                                                                      TObjectJson(TProperty(JsonPropertyNames.Id, TObjectVal(pmid2)) :: makeGetLinkProp RelValues.ActionParam pmurl2 RepresentationTypes.ActionParamDescription "")]))]
        Assert.AreEqual(HttpStatusCode.OK, result.StatusCode)
        Assert.AreEqual(new typeType(RepresentationTypes.ObjectAction), result.Content.Headers.ContentType)
        assertTransactionalCache  result 
        Assert.IsTrue(refType = "services" || result.Headers.ETag.Tag.Length > 0) 
...
let VerifyCollectionActionWithParms refType oType oid  f (api : RestfulObjectsControllerBase) =    
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([TProperty(pmid1, parm1); TProperty(pmid2, parm2) ]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action Returns Collection With Parameters"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ResultTypes.List));
                                                                              TProperty(JsonPropertyNames.ElementType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.PluralName, TObjectVal("Most Simples"));
...
let VerifyCollectionActionWithParmsSimpleOnly refType oType oid  f (api : RestfulObjectsControllerBase) =    
        ...
        let parm1 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( []));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm1"));
                                                                                        ...
                                                                                        TProperty(JsonPropertyNames.Format, TObjectVal("integer"));                                                                     
                                                                                        TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])
        let parm2 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( []));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm2"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                        TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));                                                                      
                                                                                        TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])
...
let VerifyActionWithValueParm refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([TProperty(pmid, parm1)]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Value Parameter"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyActionWithValueParmWithChoices refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let parm3 =  TObjectJson ([ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                    TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm3"));
                                                                                         TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                         TProperty(JsonPropertyNames.ReturnType, TObjectVal("number"));  
                                                                                         TProperty(JsonPropertyNames.Format, TObjectVal("integer")); 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         ...
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Value Parameter With Choices"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyActionWithValueParmWithDefault refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let parm5 = TObjectJson([ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                  TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm5"));
                                                                                       TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                       TProperty(JsonPropertyNames.ReturnType, TObjectVal("number"));   
                                                                                       TProperty(JsonPropertyNames.Format, TObjectVal("integer"));                                                                   
                                                                                       TProperty(JsonPropertyNames.Optional, TObjectVal(false))]))
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         ...
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Value Parameter With Default"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyActionWithReferenceParm refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let parm2 = TObjectJson([ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                  TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm2"));
                                                                                       TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                       TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                                       TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         ...
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Reference Parameter"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(ttc "RestfulObjects.Test.Data.MostSimple"));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyActionWithReferenceParmWithChoices refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let parm4 =  TObjectJson ([ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                    TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm4"));
                                                                                         TProperty(JsonPropertyNames.Description, TObjectVal(""));
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         ...
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Reference Parameter With Choices"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyActionWithReferenceParmsWithAutoComplete refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let parm0 =  TObjectJson ([ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy dburl0 RepresentationTypes.ActionParamDescription ""); ac0]));
                                    TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm0"));
                                                                                         TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                         TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));                                                                         
                                                                                         TProperty(JsonPropertyNames.Optional, TObjectVal(false))]))])

        let parm1 =  TObjectJson ([ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy dburl1 RepresentationTypes.ActionParamDescription ""); ac1]));
                                    TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm1"));
                                                                                         TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                         TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));                                                                         
                                                                                         TProperty(JsonPropertyNames.Optional, TObjectVal(false))]))])

        let args =  TObjectJson([TProperty(pmid0, TObjectJson([TProperty(JsonPropertyNames.Value, TObjectVal(null))]));
                                 TProperty(pmid1, TObjectJson([TProperty(JsonPropertyNames.Value, TObjectVal(null))]))]);

        let invokeRelType = RelValues.Invoke + makeParm RelParamValues.Action pid
        
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([TProperty(pmid0, parm0);TProperty(pmid1, parm1)]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Reference Parameters With Auto Complete"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyInvokeParmWithConditionalChoices refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let obj1 =  TProperty(JsonPropertyNames.Title, TObjectVal("2")) :: makeGetLinkProp choiceRel (sprintf "objects/%s/%s" mst (ktc "2"))  RepresentationTypes.Object mst
        let obj2 =  TProperty(JsonPropertyNames.Title, TObjectVal("3")) :: makeGetLinkProp choiceRel (sprintf "objects/%s/%s" mst (ktc "3"))  RepresentationTypes.Object mst
...
let VerifyInvokeParmWithConditionalChoicesErrorMalformedParm refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let expected =  [ TProperty("parm4", TObjectJson([TProperty(JsonPropertyNames.Value, TObjectVal("12")); 
...
let VerifyInvokeValueParmWithConditionalChoices refType oType oid f (api : RestfulObjectsControllerBase) =    
        ...
        let parms =  new JObject (new JProperty("parm3",  new JObject(new JProperty("value", "100"))), 
                                  new JProperty("parm4",  new JObject(new JProperty("value", "33"))));
        ...
        let expected =  [ TProperty(JsonPropertyNames.Id, TObjectVal(pmid0)); 
                          ...
                          TProperty(JsonPropertyNames.Choices, TArray([ TObjectVal(100); TObjectVal(33) ])); 
                          TProperty(JsonPropertyNames.Extensions, TObjectJson([]))] 
...
let VerifyActionWithReferenceParmWithDefault refType oType oid f (api : RestfulObjectsControllerBase) =   
        ...
        let parm6 = TObjectJson([ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                  TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm6"));
                                                                                       TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                       TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));                                                                      
                                                                                       TProperty(JsonPropertyNames.Optional, TObjectVal(false))]));
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         ...
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Reference Parameter With Default"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let VerifyActionWithChoicesAndDefault refType oType oid f (api : RestfulObjectsControllerBase) =   
        ...
        let parm1 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl1 RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm1"));
                                                                                        ...
                                                                                        TProperty(JsonPropertyNames.Format, TObjectVal("integer"));                                                                   
                                                                                        TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])
        let parm7 = TObjectJson( [ TProperty(JsonPropertyNames.Default, TObjectVal(4));
                                   TProperty(JsonPropertyNames.Choices, TArray([TObjectVal(1); TObjectVal(2); TObjectVal(3)]));
                                   TProperty(JsonPropertyNames.Links, TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl7 RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm7"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                        TProperty(JsonPropertyNames.ReturnType, TObjectVal("number"));      
                                                                                        TProperty(JsonPropertyNames.Format, TObjectVal("integer"));                                                                                           
                                                                                        TProperty(JsonPropertyNames.CustomChoices, TObjectJson( [ TProperty("1", TObjectVal(1)); TProperty("2", TObjectVal(2)); TProperty("3", TObjectVal(3))  ]  ));                                                                                                                                                           
        ...
        let parm2 = TObjectJson( [ TProperty(JsonPropertyNames.Links, TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl2 RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm2"));
                                                                                        ...
                                                                                        TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));                                                                     
                                                                                        TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])
        let parm8 = TObjectJson( [ TProperty(JsonPropertyNames.Default, TObjectJson(obj1));
                                   TProperty(JsonPropertyNames.Choices, TArray([TObjectJson(choice1); TObjectJson(choice2)]));
                                   TProperty(JsonPropertyNames.Links, TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl8 RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Parm8"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                                        TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));                                                                      
                                                                                        TProperty(JsonPropertyNames.Optional, TObjectVal(false))])) ])
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([TProperty(pmid1, parm1); TProperty(pmid7, parm7);TProperty(pmid2, parm2); TProperty(pmid8, parm8) ]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("An Action With Parameters With Choices With Defaults"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(mst));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
                         TProperty(JsonPropertyNames.Links, TArray( [ TObjectJson(makeGetLinkProp RelValues.Self purl RepresentationTypes.ObjectAction ""); 
                                                                      ...
                                                                      TObjectJson(makeGetLinkProp RelValues.DescribedBy dburl RepresentationTypes.ActionDescription "");
                                                                      TObjectJson(TProperty(JsonPropertyNames.Id, TObjectVal(pmid1)) :: makeGetLinkProp RelValues.ActionParam pmurl1 RepresentationTypes.ActionParamDescription "");
                                                                      TObjectJson(TProperty(JsonPropertyNames.Id, TObjectVal(pmid7)) :: makeGetLinkProp RelValues.ActionParam pmurl7 RepresentationTypes.ActionParamDescription "");
                                                                      TObjectJson(TProperty(JsonPropertyNames.Id, TObjectVal(pmid2)) :: makeGetLinkProp RelValues.ActionParam pmurl2 RepresentationTypes.ActionParamDescription "");
                                                                      TObjectJson(TProperty(JsonPropertyNames.Id, TObjectVal(pmid8)) :: makeGetLinkProp RelValues.ActionParam pmurl8 RepresentationTypes.ActionParamDescription "")]))]
...
let GetContributedActionOnContributee(api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([  ]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Az Contributed Action"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
...
let GetContributedActionOnContributeeBaseClass(api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([  ]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Az Contributed Action On Base Class"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(rType));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(false))]) );
...
let GetContributedActionOnContributeeWithRef(api : RestfulObjectsControllerBase) = 
        ...
        let parm2 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("With Other Action"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal(""));
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([ TProperty(pmid, parm2)  ]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Az Contributed Action With Ref Parm"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(rType));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let GetContributedActionOnContributeeWithValue(api : RestfulObjectsControllerBase) = 
        ...
        let expected = [ TProperty(JsonPropertyNames.Id, TObjectVal(pid));
                         TProperty(JsonPropertyNames.Parameters, TObjectJson([ TProperty(pmid, parm2)  ]));
                         TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("Az Contributed Action With Value Parm"));
                                                                              TProperty(JsonPropertyNames.Description, TObjectVal(""));
                                                                              TProperty(JsonPropertyNames.ReturnType, TObjectVal(rType));
                                                                              TProperty(JsonPropertyNames.MemberOrder, TObjectVal(0));
                                                                              TProperty(JsonPropertyNames.HasParams, TObjectVal(true))]) );
...
let GetContributedActionOnContributer(api : RestfulObjectsControllerBase) = 
        ...
        let parm2 = TObjectJson( [ TProperty(JsonPropertyNames.Links,  TArray( [TObjectJson(makeGetLinkProp RelValues.DescribedBy pmurl RepresentationTypes.ActionParamDescription "")]));
                                   TProperty(JsonPropertyNames.Extensions, TObjectJson([TProperty(JsonPropertyNames.FriendlyName, TObjectVal("With Action"));
                                                                                        TProperty(JsonPropertyNames.Description, TObjectVal(""));
