...
public class MenuTestEF6 : AcceptanceTestCase {
    ...
    public void TestGetMenu() {
        ...
        ClassicAssert.AreEqual(nameof(MenuTestFunctions), parsedResult["menuId"].ToString());
    ...
    public void TestGetMenuActionWithChoicesWithParameters() {
        ...
        ClassicAssert.AreEqual(@"http://localhost/menus/ChoicesMenuFunctions/actions/WithChoicesWithParameters/params/record/prompt", prompt["href"].ToString());
    }
    ...
    public void TestGetMenuActionWithChoicesWithParametersNoContext() {
        ...
        ClassicAssert.AreEqual(2, prompt["arguments"].Count());
        ClassicAssert.AreEqual(@"http://localhost/menus/ChoicesMenuFunctions/actions/WithChoicesWithParametersNoContext/params/record/prompt", prompt["href"].ToString());
    }
    ...
    public void TestGetMenuActionWithMultipleChoices() {
        ...
        ClassicAssert.AreEqual(@"http://localhost/menus/ChoicesMenuFunctions/actions/WithMultipleChoices/params/dateRecords/prompt", prompt["href"].ToString());
    }
    ...
    public void TestGetMenuActionWithMultipleChoicesNoContext() {
        ...
        ClassicAssert.AreEqual(1, prompt["arguments"].Count());
        ClassicAssert.AreEqual(@"http://localhost/menus/ChoicesMenuFunctions/actions/WithMultipleChoicesNoContext/params/dateRecords/prompt", prompt["href"].ToString());
    }
    ...
    public void TestGetMenuActionWithAutoComplete() {
        ...
        ClassicAssert.AreEqual("http://localhost/menus/AutoCompleteMenuFunctions/actions/WithAutoComplete/params/simpleRecord/prompt", parameter["links"][0]["href"].ToString());
    }
    ...
    public void TestGetMenuActionWithSingleAutoComplete() {
        ...
        ClassicAssert.AreEqual("", parameter["links"][0]["arguments"]["x-ro-searchTerm"]["value"].ToString());
        ClassicAssert.AreEqual("2", parameter["links"][0]["extensions"]["minLength"].ToString());
        ClassicAssert.AreEqual("http://localhost/menus/AutoCompleteMenuFunctions/actions/WithSingleAutoComplete/params/simpleRecord/prompt", parameter["links"][0]["href"].ToString());
    }
