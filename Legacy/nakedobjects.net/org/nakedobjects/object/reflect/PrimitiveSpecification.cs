...
// Type: org.nakedobjects.object.reflect.PrimitiveSpecification
...
namespace org.nakedobjects.@object.reflect
{
  ...
  public class PrimitiveSpecification : NakedObjectSpecification
  {
    private readonly string name;

    public PrimitiveSpecification(string name) => this.name = name;
    ...
    {
      PrimitiveSpecification primitiveSpecification = this;
      ObjectImpl.clone((object) primitiveSpecification);
      return ((object) primitiveSpecification).MemberwiseClone();
    }
  }
}
