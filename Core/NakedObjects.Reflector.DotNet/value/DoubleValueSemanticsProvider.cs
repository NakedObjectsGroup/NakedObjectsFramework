...
namespace NakedObjects.Reflector.DotNet.Value {
    public class DoubleValueSemanticsProvider : ValueSemanticsProviderAbstract<double>, IPropertyDefaultFacet {
        ...
        /// </summary>
        public DoubleValueSemanticsProvider()
            : this(null) {}

        public DoubleValueSemanticsProvider(IFacetHolder holder)
            : base(Type, holder, AdaptedType, typicalLenth, immutable, equalByContent, defaultValue) {}
        ...
        protected override double DoParse(double original, string entry) {
            try {
