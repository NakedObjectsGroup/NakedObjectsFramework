...
// Type: org.nakedobjects.viewer.skylark.tree.SimpleListSpecification
...
namespace org.nakedobjects.viewer.skylark.tree
{
  ...
  [JavaFlags(32)]
  public class SimpleListSpecification : AbstractCompositeViewSpecification, SubviewSpec
  {
    public SimpleListSpecification() => this.builder = (CompositeViewBuilder) new StackLayout((CompositeViewBuilder) new CollectionElementBuilder((SubviewSpec) this, true));
