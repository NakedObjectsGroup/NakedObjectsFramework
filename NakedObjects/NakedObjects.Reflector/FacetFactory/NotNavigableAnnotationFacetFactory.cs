...
using NakedFramework.Architecture.Attributes;
...
public sealed class NotNavigableAnnotationFacetFactory : DomainObjectFacetFactoryProcessor, IAnnotationBasedFacetFactory {
    ...
    private static INotNavigableFacet Create(NotNavigableAttribute attribute) => attribute is null ? null : NotNavigableFacet.Instance;
}