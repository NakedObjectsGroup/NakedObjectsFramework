...
(function (Spiro) {
    (function (Angular) {
        Spiro.Angular.app.service("handlers", function ($routeParams, $location, $q, $cacheFactory, repLoader, context, viewModelFactory, urlHelper, color, repHandlers, navigation, $route) {
            var handlers = this;
            ...
            handlers.handleActionDialog = function ($scope) {
                context.getObject($routeParams.sid || $routeParams.dt, $routeParams.id).then(function (object) {
                    ...
                    if (action.extensions().hasParams) {
                        ...
                        $scope.dialogTemplate = Spiro.Angular.dialogTemplate;
                    }
                }, function (error) {
                    setError(error);
                });
            ...
            handlers.handleServices = function ($scope) {
                context.getServices().then(function (services) {
                    ...
                    $scope.servicesTemplate = Spiro.Angular.servicesTemplate;
            ...
            handlers.handleService = function ($scope) {
                context.getObject($routeParams.sid).then(function (service) {
                    ...
                    $scope.serviceTemplate = Spiro.Angular.serviceTemplate;
                    $scope.actionTemplate = Spiro.Angular.actionTemplate;
                }, function (error) {
                    setError(error);
                });
            };
            ...
            handlers.handleResult = function ($scope) {
                ...
                context.getNestedObject(dt, id).then(function (object) {
                    ...
                    $scope.nestedTemplate = Spiro.Angular.nestedObjectTemplate;
            ...
            handlers.handleError = function ($scope) {
                ...
                if (error) {
                    ...
                    $scope.error = evm;
                    $scope.errorTemplate = Spiro.Angular.errorTemplate;
                }
            };
            ...
            handlers.handleAppBar = function ($scope) {
                ...
                $scope.appBar.template = Spiro.Angular.appBarTemplate;
            ...
            handlers.handleObject = function ($scope) {
                context.getObject($routeParams.dt, $routeParams.id).then(function (object) {
                    ...
                    $scope.objectTemplate = Spiro.Angular.objectTemplate;
                    $scope.actionTemplate = Spiro.Angular.actionTemplate;
                    $scope.propertiesTemplate = Spiro.Angular.viewPropertiesTemplate;
                }, function (error) {
                    setError(error);
                });
            };
            ...
            handlers.handleTransientObject = function ($scope) {
                context.getTransientObject().then(function (object) {
                    if (object) {
                        ...
                        $scope.propertiesTemplate = Spiro.Angular.editPropertiesTemplate;
                    } else {
            ...
            function setNestedCollection($scope, listOrCollection) {
                if ($routeParams.tableMode) {
                    ...
                    $scope.collectionTemplate = Spiro.Angular.nestedCollectionTableTemplate;
                } else {
                    ...
                    $scope.collectionTemplate = Spiro.Angular.nestedCollectionTemplate;
                }
            }
