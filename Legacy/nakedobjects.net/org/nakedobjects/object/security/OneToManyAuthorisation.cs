...
// Type: org.nakedobjects.object.security.OneToManyAuthorisation
...
{
  public class OneToManyAuthorisation : AbstractOneToManyPeer
  {
    private readonly AuthorisationManager authorisationManager;

    public OneToManyAuthorisation(
      OneToManyPeer decorated,
