...
namespace NakedObjects.Reflector.FacetFactory {
    ...
    /// </summary>
    public sealed class ContributedFunctionToCollectionFacetFactory : FunctionalFacetFactoryProcessor {
        private readonly ILogger<ContributedFunctionToCollectionFacetFactory> logger;

        public ContributedFunctionToCollectionFacetFactory(IFacetFactoryOrder<ContributedFunctionToCollectionFacetFactory> order, ILoggerFactory loggerFactory)
            : base(order.Order, loggerFactory, FeatureType.Actions) =>
            logger = loggerFactory.CreateLogger<ContributedFunctionToCollectionFacetFactory>();
