...
// Type: org.nakedobjects.viewer.skylark.basic.ObjectActionContent
...
namespace org.nakedobjects.viewer.skylark.basic
{
  ...
  public class ObjectActionContent : ObjectContent, ActionContent
  {
    ...
    public override NakedObject getObject() => (NakedObject) this.invocation.getTarget();
    ...
    public override NakedObjectSpecification getSpecification() => this.getObject().getSpecification();
