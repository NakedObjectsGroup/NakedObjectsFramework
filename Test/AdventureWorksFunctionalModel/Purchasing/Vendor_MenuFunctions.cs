...
namespace AW.Functions {
    ...
    public static class Vendor_MenuFunctions  {
        ...
        public static (Vendor, IContext) FindVendorByAccountNumber(string accountNumber,IContext context) =>
            Helpers.SingleObjectWarnIfNoMatch(context.Instances<Vendor>().Where(x => x.AccountNumber == accountNumber), context);
