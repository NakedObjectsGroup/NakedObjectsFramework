...
namespace NakedObjects.Web.UnitTests.Selenium {
    ...
    public abstract class CiceroHome : AWTest
    {
        [TestMethod]
        public void HomeWithoutArguments()
        {
    ...
    //    [TestClass, Ignore]
    public class CiceroHomeIe : CiceroHome {
        [ClassInitialize]
    ...
    [TestClass]
    public class CiceroHomeFirefox : CiceroHome
    {
        [ClassInitialize]
        public new static void InitialiseClass(TestContext context) {
            AWTest.InitialiseClass(context);
   ...
   // [TestClass, Ignore]
    public class CiceroHomeChrome : CiceroHome
    {
        [ClassInitialize]
        public new static void InitialiseClass(TestContext context) {
