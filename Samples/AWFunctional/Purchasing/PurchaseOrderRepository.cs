...
namespace AdventureWorksModel
{
    ...
    public class PurchaseOrderRepository : AbstractFactoryAndRepository
    {
        ...
        [MemberOrder(2)]
        public IQueryable<PurchaseOrderHeader> AllPurchaseOrders(IQueryable<PurchaseOrderHeader> allPoHs)
        {
            return allPoHs.OrderByDescending(poh => poh.ModifiedDate);
        }
        #endregion
        ...
        public IQueryable<PurchaseOrderHeader> AllOpenPurchaseOrders(IFunctionalContainer container)
        {
        ...
        public IQueryable<PurchaseOrderHeader> OpenPurchaseOrdersForVendor([ContributedAction("Purchase Orders")] Vendor vendor, IFunctionalContainer container)
        {
            return AllOpenPurchaseOrders(container).Where(poh => poh.Vendor.BusinessEntityID == vendor.BusinessEntityID);
        }

        [PageSize(20)]
        public IQueryable<Vendor> AutoComplete0OpenPurchaseOrdersForVendor([MinLength(2)] string name, IQueryable<Vendor> vendors)
        {
        ...
        [PageSize(20)]
        public IQueryable<Vendor> AutoComplete0ListPurchaseOrders([MinLength(2)] string name, IQueryable<Vendor> vendors)
        {
            return vendors.Where(v => v.Name.ToUpper().StartsWith(name.ToUpper()));
        }
        ...
        [PageSize(20)]
        public IQueryable<Product> AutoComplete0OpenPurchaseOrdersForProduct([MinLength(2)] string name, IQueryable<Product> products)
        {
        ...
        [PageSize(20)]
        public IQueryable<Vendor> AutoComplete0CreateNewPurchaseOrder([MinLength(2)] string name, IQueryable<Vendor> vendors)
        {
            return vendors.Where(v => v.Name.ToUpper().StartsWith(name.ToUpper()));
        }
        #endregion
        ...
        #region FindById
        [MemberOrder(7)]
        public PurchaseOrderHeader FindById(int id, IQueryable<PurchaseOrderHeader> headers)
        {
            var query = from obj in headers
