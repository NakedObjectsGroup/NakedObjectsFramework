...
(function (Spiro) {
    (function (Angular) {
        Spiro.Angular.app.service('repHandlers', function ($q, $location, $cacheFactory, repLoader, context, urlHelper) {
            ...
            repHandlers.prompt = function (promptRep, id, searchTerm) {
                ...
                return repLoader.populate(promptRep, true).then(function (p) {
                    ...
                    var cvms = _.map(p.choices(), function (v, k) {
                        return Spiro.Angular.ChoiceViewModel.create(v, id, k, searchTerm);
                    });
            ...
            repHandlers.conditionalChoices = function (promptRep, id, args) {
                ...
                return repLoader.populate(promptRep, true).then(function (p) {
                    ...
                    var cvms = _.map(p.choices(), function (v, k) {
                        return Spiro.Angular.ChoiceViewModel.create(v, id, k);
                    });
...
//# sourceMappingURL=spiro.angular.services.representationhandlers.js.map
