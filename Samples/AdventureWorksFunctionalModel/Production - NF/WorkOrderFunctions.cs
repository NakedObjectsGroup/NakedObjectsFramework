...
namespace AdventureWorksModel
{
    public static class WorkOrderFunctions
    {
        ...
        public static WorkOrder Updating(WorkOrder wo, [Now] DateTime now)
        {
        ...
        public static DateTime DefaultStartDate(WorkOrder wo, [Now] DateTime now)
        {
            return now;
        }

        public static DateTime DefaultDueDate([Now] DateTime now)
        {
