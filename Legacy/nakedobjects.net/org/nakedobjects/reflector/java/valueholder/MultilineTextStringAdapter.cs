...
// Type: org.nakedobjects.reflector.java.valueholder.MultilineTextStringAdapter
...
{
  [JavaInterfaces("1;org/nakedobjects/object/value/MultilineStringValue;")]
  public class MultilineTextStringAdapter : AbstractNakedValue, MultilineStringValue
  {
    private readonly MultilineTextString adaptee;

    public MultilineTextStringAdapter(MultilineTextString adaptee) => this.adaptee = adaptee;
    ...
    public override string ToString()
    {
      ...
      toString.append("string", this.adaptee.stringValue());
