...
// Type: org.apache.log4j.nt.test.NTMin
...
namespace org.apache.log4j.nt.test
{
  public class NTMin
  {
    [JavaFlags(8)]
    ...
    public static void Usage(string msg)
    {
      ...
      ((PrintStream) java.lang.System.err).println(new StringBuffer().append("Usage: java ").append((object) Class.FromType(typeof (NTMin))).append("").ToString());
      java.lang.System.exit(1);
    }

    [JavaFlags(8)]
    public static void init() => BasicConfigurator.configure((Appender) new NTEventLogAppender());
    ...
    {
      NTMin ntMin = this;
      ObjectImpl.clone((object) ntMin);
      return ((object) ntMin).MemberwiseClone();
    }
