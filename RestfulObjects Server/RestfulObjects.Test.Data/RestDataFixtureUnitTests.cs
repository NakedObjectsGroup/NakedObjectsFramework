...
namespace RestfulObjects.Test.Data {
    public class RestDataFixtureUnitTests {
        ...
        //public void Install() {
        //    var ms1 = Container.NewTransientInstance<MostSimple>(Id = 1);
          
        //    Container.Persist(ref ms1);

        //    var ms2 = Container.NewTransientInstance<MostSimple>(Id = 2);
        
        //    Container.Persist(ref ms2);

        //    var ms3 = Container.NewTransientInstance<MostSimple>(Id = 3);
