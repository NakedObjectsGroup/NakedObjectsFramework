...
namespace NakedObjects.Meta.Facet {
    ...
    public abstract class TitleFacetAbstract : FacetAbstract, ITitleFacet {
        ...
        public virtual string GetTitleWithMask(string mask, INakedObjectAdapter nakedObjectAdapter, INakedObjectManager nakedObjectManager) => GetTitle(nakedObjectAdapter, nakedObjectManager);
