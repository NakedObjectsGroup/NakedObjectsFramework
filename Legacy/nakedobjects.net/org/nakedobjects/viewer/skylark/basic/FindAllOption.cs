...
// Type: org.nakedobjects.viewer.skylark.basic.FindAllOption
...
{
  public class FindAllOption : AbstractUserAction
  {
    public FindAllOption()
      : base("Find Matching Objects")
    {
    }
    ...
    public override string getDescription(View view) => "Find all the matching objects";
  }
}
