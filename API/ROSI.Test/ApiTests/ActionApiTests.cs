...
public class ActionApiTests : AbstractRosiApiTests {
    ...
    [Test]
    public async Task TestGetParametersOnDetailsWithOptions() {
    ...
    public async Task TestGetParametersOnDetails() {
        var objectRep = GetObject(FullName<ClassWithActions>(), "1");
        var details = await objectRep.GetAction(nameof(ClassWithActions.ActionWithMixedParmsReturnsObject)).GetDetails();
        Assert.IsNotNull(details);
    ...
    [Test]
    public void TestGetParametersWithOptions() {
        var objectRep = GetObject(FullName<ClassWithActions>(), "1");
    ...
    public void TestGetParameters() {
        ...
        var parameters = action.GetParameters().Result.Parameters();
    ...
    [Test]
    public void TestInvokeNoParmReturnsObjectActionWithOptions() {
    ...
    [Test]
    public void TestValidateNoParmWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
        var action = parsedResult.GetAction(nameof(ClassWithActions.ActionNoParmsReturnsObject));
        Assert.AreEqual(HttpMethod.Get, action?.GetLinks().GetInvokeLink()?.GetMethod());
    ...
    [Test]
    public void TestInvokeNoParmReturnsListActionWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
    ...
    [Test]
    public void TestInvokeNoParmReturnsVoidActionWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
    ...
    [Test]
    public void TestInvokeWithValueParmsReturnsObjectActionWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
    ...
    [Test]
    public void TestValidateWithValueParmsReturnsObjectActionWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
        var action = parsedResult.GetAction(nameof(ClassWithActions.ActionWithValueParmsReturnsObject));
        Assert.AreEqual(HttpMethod.Get, action.GetLinks().GetInvokeLink().GetMethod());
    ...
    public void TestValidateWithValueParmsReturnsObjectAction() {
        ...
        Assert.AreEqual(2, args?.Count());
        action.Validate(1, "test").Wait();
    }

    [Test]
    public void TestInvokeWithNamedValueParmsReturnsObjectActionWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
        var action = parsedResult.GetAction(nameof(ClassWithActions.ActionWithValueParmsReturnsObject));
        Assert.AreEqual(HttpMethod.Get, action.GetLinks().GetInvokeLink().GetMethod());
    ...
    [Test]
    public void TestInvokeWithRefParmsReturnsObjectActionWithOptions() {
    ...
    [Test]
    public void TestInvokeWithMixedParmsReturnsObjectActionWithOptions() {
        var o1 = GetObject(FullName<Class>(), "1");
    ...
    [Test]
    public void TestValidateWithMixedParmsWithOptions() {
        var o1 = GetObject(FullName<Class>(), "1");
    ...
    [Test]
    public void TestInvokeWithValueParmsReturnsObjectIdempotentActionWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
    ...
    [Test]
    public void TestInvokeWithRefParmsReturnsObjectIdempotentActionWithOptions() {
        var o1 = GetObject(FullName<Class>(), "1");
        var o2 = GetObject(FullName<Class>(), "2");
    ...
    [Test]
    public void TestInvokeWithMixedParmsReturnsObjectIdempotentActionWithOptions() {
        var o1 = GetObject(FullName<Class>(), "1");
    ...
    [Test]
    public void TestInvokeWithValueParmsReturnsObjectPotentActionWithOptions() {
        var parsedResult = GetObject(FullName<ClassWithActions>(), "1");
    ...
    [Test]
    public void TestInvokeWithRefParmsReturnsObjectPotentActionWithOptions() {
        var o1 = GetObject(FullName<Class>(), "1");
        var o2 = GetObject(FullName<Class>(), "2");
    ...
    [Test]
    public void TestInvokeWithMixedParmsReturnsObjectPotentActionWithOptions() {
        var o1 = GetObject(FullName<Class>(), "1");
    ...
    [Test]
    public void TestInvokeWithWrongParms1WithOptions() {
    ...
    [Test]
    public void TestValidateWithWrongParms1WithOptions() {
        var o1 = GetObject(FullName<ClassWithScalars>(), "1");
