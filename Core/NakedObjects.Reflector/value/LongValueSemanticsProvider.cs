...
namespace NakedObjects.Reflector.DotNet.Value {
    public class LongValueSemanticsProvider : ValueSemanticsProviderAbstract<long>, IPropertyDefaultFacet {
        ...
        /// </summary>
        public LongValueSemanticsProvider(INakedObjectReflector reflector)
            : this(reflector, null) { }

        public LongValueSemanticsProvider(INakedObjectReflector reflector, IFacetHolder holder)
