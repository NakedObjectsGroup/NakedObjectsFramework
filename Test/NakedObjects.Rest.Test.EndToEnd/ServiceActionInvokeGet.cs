...
public class ServiceActionInvokeGet : AbstractActionInvokeGet {
    ...
    protected override string FilePrefix => "Service-Action-Invoke-Get-";
    ...
    [TestMethod]
    public void ActionWithScalarParametersAsQueryString() {
        DoActionWithScalarParametersAsQueryString();
    }
