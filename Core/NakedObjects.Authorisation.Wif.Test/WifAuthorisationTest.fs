...
type XAttribute(name : string, [<ParamArray>] values : obj []) = 
    inherit System.Xml.Linq.XAttribute(System.Xml.Linq.XName.op_Implicit (name), values)

type TestSession(p : IPrincipal) = 
    let principal = p
    interface ISession with
        member x.IsAuthenticated = true
        member x.Principal = principal : IPrincipal
        member x.UserName = principal.Identity.Name
...
type WifTests() = 
    ...
    let testXml = 
        ...
        + "<claim value=\"claim1value\" type=\"claim1type\"/>" + "</member>" + "<member name=\"member3\" type=\"Action\">" 
        + "<claim value=\"claim1value\" type=\"claim1type\"/>" + "</member>" + "<member name=\"member4\" type=\"ViewField\">" 
        + "<claim value=\"claim1value\" type=\"claim1type\"/>" + "</member>" + "<member name=\"member4\" type=\"EditField\">" 
        + "<claim value=\"claim1value\" type=\"claim1type\"/>" + "</member>" + "</class>" + "<class name=\"class2\" fullname=\"ns.class2\">" 
        + "<member name=\"member1\" type=\"ViewField\">" + "<claim value=\"claim2value\" type=\"claim2type\"/>" + "</member>" 
        + "<member name=\"member2\" type=\"EditField\">" + "<claim value=\"claim2value\" type=\"claim2type\"/>" + "</member>" 
        + "<member name=\"member3\" type=\"Action\">" + "<claim value=\"claim2value\" type=\"claim2type\"/>" + "</member>" + "</class></testxml>"
