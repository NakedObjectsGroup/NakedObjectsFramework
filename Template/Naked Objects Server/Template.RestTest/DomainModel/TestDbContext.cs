...
namespace Template.Test.Data {
    ...
    public class DatabaseInitializer<T> : DropCreateDatabaseAlways<T> where T : TestDbContext {
        protected override void Seed(T context) {
            ...
            context.SimpleTypes.Add(fred);
            context.SimpleTypes.Add(new Foo {Name = "Bill"});
            context.SimpleTypes.Add(new Foo {Name = "Jack"});
            context.SimpleTypes.Add(new Foo {Name = "hide it"});
    ...
    public abstract class TestDbContext : DbContext {
        ...
        public DbSet<Foo> SimpleTypes { get; set; }
