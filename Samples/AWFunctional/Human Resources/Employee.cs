...
namespace AdventureWorksModel {
    ...
    public class Employee : IEmployee {
        ...
        #region Constructors
        //TODO: extend to include all mandatory fields
        public Employee(int businessEntityID, Person contactDetails, string nationalIDNumber, string jobTitle)
        {
        ...
        [PageSize(20)]
        public IQueryable<Employee> AutoCompleteManager([MinLength(2)] string name, IFunctionalContainer container) {
            return EmployeeRepository.QueryEmployeesByName(null, name, container);
        }
