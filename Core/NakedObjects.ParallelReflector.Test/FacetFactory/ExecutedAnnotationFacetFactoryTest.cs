...
namespace NakedObjects.ParallelReflect.Test.FacetFactory {
    ...
    public class ExecutedAnnotationFacetFactoryTest : AbstractFacetFactoryTest {
        ...
        protected override Type[] SupportedTypes => new[] {typeof(IExecutedFacet)};
...
// ReSharper disable once UnusedMember.Local
        ...
        public override void SetUp() {
            base.SetUp();
            facetFactory = new ExecutedAnnotationFacetFactory(new FacetFactoryOrder<ExecutedAnnotationFacetFactory>(), LoggerFactory);
        }
