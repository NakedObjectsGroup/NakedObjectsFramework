...
namespace NakedObjects.Reflector.DotNet.Value {
    public class UIntValueSemanticsProvider : ValueSemanticsProviderAbstract<uint>, IPropertyDefaultFacet {
        ...
        /// </summary>
        public UIntValueSemanticsProvider(INakedObjectReflector reflector)
            : this(reflector, null) {}

        public UIntValueSemanticsProvider(INakedObjectReflector reflector, IFacetHolder holder)
